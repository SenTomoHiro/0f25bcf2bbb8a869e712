...
十二月十六：尾牙
十二月廿四：祭灶日
`,bn=new Map([["正月",1],["一月",1],["二月",2],["三月",3],["四月",4],["五月",5],["六月",6],["七月",7],["八月",8],["九月",9],["十月",10],["十一月",11],["冬月",11],["十二月",12],["腊月",12]]),Gn=new Map(["初一","初二","初三","初四","初五","初六","初七","初八","初九","初十","十一","十二","十三","十四","十五","十六","十七","十八","十九","二十","廿一","廿二","廿三","廿四","廿五","廿六","廿七","廿八","廿九","三十"].map((u,n)=>[u,n+1]));function Zn(u=M2){let n=null;const t=[];return u.split(/\r?\n/u).forEach((e,i)=>{const a=e.trim();if(a==="# 常用传统节日"){n="常用传统节日";return}if(a==="# 其他传统民俗节日"){n="其他传统民俗节日";return}if(!a||a.startsWith("#"))return;if(!n)throw new Error(`传统节日.txt 第 ${i+1} 行缺少分类标题`);const F=a.match(/^((?:正|一|二|三|四|五|六|七|八|九|十|十一|十二|冬|腊)月)(初一|初二|初三|初四|初五|初六|初七|初八|初九|初十|十一|十二|十三|十四|十五|十六|十七|十八|十九|二十|廿一|廿二|廿三|廿四|廿五|廿六|廿七|廿八|廿九|三十)[：:](.+)$/u);if(!F)throw new Error(`传统节日.txt 第 ${i+1} 行格式无法识别：${a}`);const r=bn.get(F[1]),E=Gn.get(F[2]),g=F[3].split(/[、，,]/u).map(h=>h.trim()).filter(Boolean);if(!r||!E||g.length===0)throw new Error(`传统节日.txt 第 ${i+1} 行内容不完整：${a}`);t.push({分类:n,月:r,日:E,名称:g})}),t}const Hn=Zn();function D2(u,n){return g1(u,n)}function J2(u){const n=k0(u).日柱[0];let t=P.indexOf("戊")-P.indexOf(n);return t<0&&(t+=10),h0(u,(t+40)*86400)}function kn(u,n,t){const e=[],i=[];if(!n.是否闰月)for(const F of Hn){if(F.月!==n.月||F.日!==n.日)continue;(F.分类==="常用传统节日"?e:i).push(...F.名称)}n.月===12&&n.日>=29&&n.年!==t.年&&e.push("除夕");const a=C0(u.年,"清明");return D2(u,h0(a,-86400))&&i.push("寒食节"),D2(u,J2(C0(u.年,"立春")))&&i.push("春社"),D2(u,J2(C0(u.年,"立秋")))&&i.push("秋社"),{常用传统节日:e,其他传统民俗节日:i,全部:[...new Set([...e,...i])]}}function x0(u){const n=E1(u).getLunar(),t=n.getMonth()<0,e=`${n.getMonthInChinese()}月`,i=n.getDayInChinese();return{年:n.getYear(),月:Math.abs(n.getMonth()),日:n.getDay(),是否闰月:t,月名:e,日名:i,显示:`${e}${i}`}}function On(u){return kn(u,x0(u),x0(h0(u,86400)))}function D1(u){return On(u).全部}const A1=["匹配名称","神像","宝诰标题","宝诰出处","宝诰版本说明"],$n=["简介出处","参校来源"],Xn=[...A1,...$n],A2=new Map([["正月",1],["一月",1],["二月",2],["三月",3],["四月",4],["五月",5],["六月",6],["七月",7],["八月",8],["九月",9],["十月",10],["十一月",11],["冬月",11],["十二月",12],["腊月",12]]),B2=new Map(["初一","初二","初三","初四","初五","初六","初七","初八","初九","初十","十一","十二","十三","十四","十五","十六","十七","十八","十九","二十","廿一","廿二","廿三","廿四","廿五","廿六","廿七","廿八","廿九","三十"].map((u,n)=>[u,n+1]));function B1(u,n){return u.slice(0,n).split(/\r?\n/u).length}function Ln(u,n){return u.match(new RegExp(`^${n}：(.*)$`,"mu"))?.[1].trim()??null}function $0(u,n){return u.match(new RegExp(`^${n}：(.*)$`,"mu"))?.[1].trim()??null}function I2(u,n,t){const e=u.match(new RegExp(`^【${n}】[ \\t]*\\r?\\n([\\s\\S]*?)^【${t}】[ \\t]*$`,"mu"));return e?e[1].replace(/^(?:[ \t]*\r?\n)+/u,"").replace(/(?:\r?\n[ \t]*)+$/u,""):null}function vn(u){return u.split("；").map(n=>n.trim()).filter(Boolean)}function Jn(u){const n=[...B2.keys()].join("|"),t=[...A2.keys()].sort((E,g)=>g.length-E.length).join("|"),e=u.match(new RegExp(`^农历(${t})(${n})(?:至(?:(${t}))?(${n}))?$`,"u"));if(!e)return null;const i=A2.get(e[1]),a=B2.get(e[2]),F=e[3]?A2.get(e[3]):i,r=e[4]?B2.get(e[4]):a;return!i||!a||!F||!r||i!==F||a>r?null:{原文:u,月:i,起始日:a,结束日:r}}function c1(u,n,t,e,i){const a=$0(t,"日期"),F=$0(t,"名称"),r=$0(t,"类型"),E=$0(t,"详情人物")??"",g=I2(t,"纪念简介开始","纪念简介结束")??"",h=$0(t,"纪念简介出处")??"",D=B1(n,e);if(!a||!F||!r)return i.push({文件名:u,行号:D,信息:"纪念事件必须完整填写日期、名称和类型"}),null;const l=Jn(a);return l?{日期:l,名称:F,类型:r,详情人物名称:E,纪念简介:g,纪念简介出处:h}:(i.push({文件名:u,行号:D,信息:`纪念事件日期格式无法解析：${a}`}),null)}function Un(u,n,t,e,i){const a=[],F=/^【纪念事件】[ \t]*\r?\n([\s\S]*?)^【纪念结束】[ \t]*$/gmu;let r;for(;(r=F.exec(t))!==null;){const E=c1(u,n,r[1],e+r.index,i);E&&a.push(E)}return a}function Pn(u){return!!(u.神像||u.宝诰||u.简介)}function T2(u){return!!(u.事件.纪念简介||u.人物&&Pn(u.人物))}function qn(u,n){const t={文件名:u,人物:[],独立纪念事件:[],错误:[]},e=/^【人物：([^】\r\n]+)】[ \t]*\r?\n([\s\S]*?)^【人物结束】[ \t]*$/gmu,i=new Map,a=new Map;let F;for(;(F=e.exec(n))!==null;){const _=F[1].trim(),S=F[2],p=B1(n,F.index),G=i.get(_);if(G!==void 0){t.错误.push({文件名:u,行号:p,信息:`人物主名称“${_}”重复，首次出现在第 ${G} 行`});continue}i.set(_,p);const H=Object.fromEntries(Xn.map($=>[$,Ln(S,$)]));for(const $ of A1)H[$]===null&&t.错误.push({文件名:u,行号:p,信息:`人物“${_}”缺少“${$}”字段`});const k=I2(S,"宝诰开始","宝诰结束"),w=I2(S,"简介开始","简介结束");k===null&&t.错误.push({文件名:u,行号:p,信息:`人物“${_}”缺少完整宝诰区块`}),w===null&&t.错误.push({文件名:u,行号:p,信息:`人物“${_}”缺少完整简介区块`});const v={主名称:_,匹配名称:vn(H.匹配名称??""),纪念事件:Un(u,n,S,F.index,t.错误),神像:H.神像??"",宝诰标题:H.宝诰标题??"",宝诰出处:H.宝诰出处??"",宝诰版本说明:H.宝诰版本说明??"",宝诰:k??"",简介:w??"",简介出处:H.简介出处??"",参校来源:H.参校来源??""},e0=[...new Set([v.主名称,...v.匹配名称])];for(const $ of e0){const X=a.get($);X&&X.主名称!==_?t.错误.push({文件名:u,行号:p,信息:`匹配名称“${$}”同时属于“${X.主名称}”与“${_}”（首次出现在第 ${X.行号} 行）`}):a.set($,{主名称:_,行号:p})}t.人物.push(v)}const r=/^【独立纪念事件】[ \t]*\r?\n([\s\S]*?)^【独立纪念结束】[ \t]*$/gmu;for(;(F=r.exec(n))!==null;){const _=c1(u,n,F[1],F.index,t.错误);_&&t.独立纪念事件.push(_)}const E=n.match(/^【人物：/gmu)?.length??0,g=n.match(/^【人物结束】[ \t]*$/gmu)?.length??0,h=n.match(/^【纪念事件】[ \t]*$/gmu)?.length??0,D=n.match(/^【纪念结束】[ \t]*$/gmu)?.length??0,l=n.match(/^【独立纪念事件】[ \t]*$/gmu)?.length??0,B=n.match(/^【独立纪念结束】[ \t]*$/gmu)?.length??0;E===0&&t.错误.push({文件名:u,行号:1,信息:"未找到任何人物区块"}),(E!==t.人物.length||g!==E)&&t.错误.push({文件名:u,行号:1,信息:"存在未闭合或格式不正确的人物区块"});const x=t.人物.reduce((_,S)=>_+S.纪念事件.length,0);(h!==D||h!==x)&&t.错误.push({文件名:u,行号:1,信息:"存在未归属人物或格式不正确的纪念事件块"}),(l!==B||l!==t.独立纪念事件.length)&&t.错误.push({文件名:u,行号:1,信息:"存在格式不正确的独立纪念事件块"});const f=new Map,y=[...t.人物.flatMap(_=>_.纪念事件.map(S=>({事件:S,归属:_.主名称}))),...t.独立纪念事件.map(_=>({事件:_,归属:"独立纪念"}))];for(const{事件:_,归属:S}of y){const p=`${_.日期.原文}\0${_.名称}\0${_.类型}`,G=f.get(p);G?t.错误.push({文件名:u,行号:1,信息:`纪念事件“${_.名称}”重复出现在“${G}”与“${S}”`}):f.set(p,S),_.详情人物名称&&!i.has(_.详情人物名称)&&t.错误.push({文件名:u,行号:1,信息:`纪念事件“${_.名称}”引用了不存在的人物“${_.详情人物名称}”`})}for(const _ of l1(t))T2(_)||t.错误.push({文件名:u,行号:1,信息:`纪念事件“${_.事件.日期.原文} ${_.名称}”缺少神像、宝诰、人物简介或纪念简介`});return t}function l1(u){if(!u)return[];const n=new Map(u.人物.map(t=>[t.主名称,t]));return[...u.人物.flatMap(t=>t.纪念事件.map(e=>({名称:e.名称,类型:e.类型,人物:e.详情人物名称?n.get(e.详情人物名称)??null:t,事件:e}))),...u.独立纪念事件.map(t=>({名称:t.名称,类型:t.类型,人物:t.详情人物名称?n.get(t.详情人物名称)??null:null,事件:t}))]}function d1(u,n){if(!u||n.是否闰月)return[];const t=e=>e.日期.月===n.月&&n.日>=e.日期.起始日&&n.日<=e.日期.结束日;return l1(u).filter(e=>t(e.事件))}const Wn="《太上北斗二十八章经》",c2="《太上玄灵北斗本命延生真经注》",Rn={正月:1,二月:2,三月:3,四月:4,五月:5,六月:6,七月:7,八月:8,九月:9,十月:10,十一月:11,十二月:12};function _1(u){const n={一:1,二:2,三:3,四:4,五:5,六:6,七:7,八:8,九:9};return u==="初十"||u==="十"?10:u==="二十"?20:u==="三十"?30:u.startsWith("初")?n[u.slice(1)]??null:u.startsWith("十")?10+(n[u.slice(1)]??0):u.startsWith("廿")?20+(n[u.slice(1)]??0):null}function g0(u,n,t,e){return{文件名:u,行号:n,原文:t,信息:e}}function U2(u,n,t){const e={};if(!u)return t.push(g0(n,0,"","缺少配置文件")),e;t.push(...u.错误);for(const i of u.规则){const a=Rn[i.条件];if(!a)continue;const F=i.内容.split("、").map(_1);if(F.some(r=>r===null)){t.push(g0(n,i.行号,i.原文,"包含无法识别的农历日期"));continue}e[a]=F}return Object.keys(e).length!==12&&t.push(g0(n,0,"","必须完整配置十二个月")),e}function x1(u){const n=[],t="斗降日-太上北斗二十八章经.txt",e="斗降日-北斗本命延生真经注.txt",i="本命星官.txt",a=u.find(y=>y.文件名===t),F=u.find(y=>y.文件名===e),r=u.find(y=>y.文件名===i),E=U2(a,t,n),g=U2(F,e,n),h=F?.规则.find(y=>y.条件==="每月"),D=F?.规则.find(y=>y.条件==="干支日"),l=F?.规则.find(y=>y.条件==="闰月"),B=h?.内容.split("、").map(_1)??[],x=D?.内容.split("、").filter(Boolean)??[];(B.some(y=>y===null)||B.length!==2)&&n.push(g0(e,h?.行号??0,h?.原文??"","每月规则必须配置初三、廿七")),x.join("、")!=="甲子、庚申"&&n.push(g0(e,D?.行号??0,D?.原文??"","干支日必须配置甲子、庚申")),l?.内容!=="从前月"&&n.push(g0(e,l?.行号??0,l?.原文??"","必须明确配置“闰月从前月”"));const f={};if(!r)n.push(g0(i,0,"","缺少配置文件"));else{n.push(...r.错误);for(const y of r.规则){const _=[...y.条件];if(_.some(S=>!M.includes(S))){n.push(g0(i,y.行号,y.原文,"包含无效地支"));continue}for(const S of _)f[S]=y.内容}}return Object.keys(f).length!==12&&n.push(g0(i,0,"","必须完整覆盖十二出生年支")),n.length>0?{配置:null,错误:n}:{配置:{二十八章经:E,真经注:g,真经注每月:B,真经注干支日:x,出生年支本命星官:f},错误:[]}}function P2(u){return`${u.月名}${u.日名}`}function y1(u,n,t){const e=t;if(!u)return{斗降日:{命中:!1,名称:"无",依据:[],来源显示:""},本命下日:`${e}年生人`,本命星官:"配置错误"};const i=[];!n.是否闰月&&u.二十八章经[n.月]?.includes(n.日)&&i.push({来源:Wn,规则:P2(n)}),u.真经注[n.月]?.includes(n.日)&&i.push({来源:c2,规则:`${n.是否闰月?"闰月从前月·":""}${P2(n)}`}),u.真经注每月.includes(n.日)&&i.push({来源:c2,规则:`每月${n.日名}`}),u.真经注干支日.includes(t)&&i.push({来源:c2,规则:`${t}日`});const F=[...new Set(i.map(E=>E.来源))].join("、"),r=e[1];return{斗降日:{命中:i.length>0,名称:i.length>0?"北斗下降":"无",依据:i,来源显示:F},本命下日:`${e}年生人`,本命星官:u.出生年支本命星官[r]}}function Qn(u){return u.日===1?u.月名:u.日名}function Kn(u,n,t=[]){const e=[...u,...n,...t],i=e.length<=3?e:e.slice(0,2);return{显示事件:i,其余事件数:Math.max(0,e.length-i.length)}}function Vn(u,n,t,e){return Array.from({length:a1(u,n)},(i,a)=>{const F=a+1,r=o1(u,n+1,F),E=x0(r),g=D1(r),h=d1(t,E).map(f=>f.名称),D=k0(r).日柱,B=y1(e??null,E,D).斗降日.命中?["斗降"]:[],x=Kn(g,h,B);return{公历日:F,农历:E,农历摘要:Qn(E),传统节日:g,神圣纪念:h,斗降:B,...x}})}const n5={enableHighAccuracy:!1,timeout:1e4,maximumAge:3e5},u5={enableHighAccuracy:!0,timeout:15e3,maximumAge:0};function t5(){return typeof navigator>"u"?void 0:navigator.geolocation}function e5(){return typeof window>"u"||window.isSecureContext}function i5(u){return u===1||u===2||u===3?u:null}function s5(u){return u===1?"已拒绝":u===2?"不可用":u===3?"超时":"未知错误"}function a5(u,n){typeof console>"u"||console.warn("[定位诊断] GeolocationPositionError",{code:u.code,message:u.message??"",attempt:n})}function f1(){const u=typeof window<"u",n=typeof navigator<"u";return{HTTPS:!u||window.isSecureContext&&window.location.protocol==="https:",支持定位:n&&!!navigator.geolocation,页面可见:typeof document>"u"||document.visibilityState==="visible"}}function F5(u=t5(),n=e5()){return n?u?new Promise(t=>{let e=!1;const i=F=>{e||(e=!0,t(F))},a=(F,r)=>{try{u.getCurrentPosition(({coords:E})=>{if(!Number.isFinite(E.longitude)||E.longitude<-180||E.longitude>180||!Number.isFinite(E.latitude)||E.latitude<-90||E.latitude>90){i({成功:!1,原因:"坐标无效",错误码:null,尝试次数:F});return}i({成功:!0,经度:E.longitude,纬度:E.latitude,精度米:Number.isFinite(E.accuracy)?E.accuracy:0,尝试次数:F})},E=>{if(a5(E,F),F===1&&(E.code===2||E.code===3)){a(2,u5);return}i({成功:!1,原因:s5(E.code),错误码:i5(E.code),尝试次数:F})},r)}catch{i({成功:!1,原因:"未知错误",错误码:null,尝试次数:F})}};a(1,n5)}):Promise.resolve({成功:!1,原因:"不支持",错误码:null,尝试次数:0}):Promise.resolve({成功:!1,原因:"非安全连接",错误码:null,尝试次数:0})}function j1(u){switch(u){case"已拒绝":return"Safari未允许定位。请检查iPhone 设置 → 隐私与安全性 → 定位服务，以及当前网站的位置权限。";case"不可用":return"Safari暂时无法取得位置，已自动重试；请保持页面可见后重新获取。";case"超时":return"定位超时，已自动重试；请保持页面可见后重新获取。";case"不支持":return"当前浏览器不支持定位。";case"非安全连接":return"当前页面不是安全连接，无法使用定位。";default:return"暂时无法取得位置，请重新获取。"}}const I1=`# 季罗睺日
# 格式：季节：罗睺日
# 季节边界按立春、立夏、立秋、立冬。
...
宝诰版本说明：采用11A稳定本。
【宝诰开始】
志心皈命礼。混元始祖，一炁分真，多劫之前，即修至道，勤苦备悉经纬，逾深万法千门，罔不斯历，救灾拔难，除害荡妖，功济生灵，名高玉籍，众真推仰，宜有甄升，大悲大愿，大孝大仁，九州都仙太史，高明大使，雷霆泰省，天机伏魔上相，至道玄应，神功妙济，掌九天司职，太一定命，注生真君，三天按察都，检校普奏谏议大夫，天医大帝，度人祖师，净明普化天尊。
【宝诰结束】
【简介开始】
...
【纪念简介开始】
神功妙济真君是传统神圣降诞日资料所载尊号，八月初一为其圣诞。因不同资料对具体身份的指向并不一致，此处保留古籍纪名与日期，不强行并入某一人物。
【纪念简介结束】
【独立纪念结束】
...
九月初六：阴阳宅禁日
十二月初二：阴阳宅禁日
`;function H2(u,n){const t={文件名:u,规则:[],错误:[]};return n.split(/\r?\n/u).forEach((e,i)=>{const a=i+1,F=e.trim();if(!F||F.startsWith("#"))return;const r=F.indexOf("："),E=F.indexOf(":"),g=[r,E].filter(B=>B>=0),h=g.length>0?Math.min(...g):-1;if(h<0){t.错误.push({文件名:u,行号:a,原文:e,信息:"缺少冒号分隔符"});return}const D=F.slice(0,h).trim(),l=F.slice(h+1).trim();if(!D||!l){t.错误.push({文件名:u,行号:a,原文:e,信息:"冒号两侧都必须有内容"});return}t.规则.push({条件:D,内容:l,行号:a,原文:e})}),t}function r5(){return Object.entries(Object.assign({"../../配置/传统节日.txt":M2,"../../配置/季罗睺日.txt":I1,"../../配置/年罗睺日.txt":m1,"../../配置/斗降日-北斗本命延生真经注.txt":S1,"../../配置/斗降日-太上北斗二十八章经.txt":w1,"../../配置/日吉凶.txt":b2,"../../配置/日宜忌.txt":G2,"../../配置/时辰吉凶.txt":z1,"../../配置/时辰宜忌.txt":p1,"../../配置/时辰神煞.txt":N1,"../../配置/月罗睺日.txt":Y1,"../../配置/本命星官.txt":M1,"../../配置/杀师时.txt":T1,"../../配置/现代时辰宜忌.txt":Z2,"../../配置/神圣纪念与神仙资料.txt":b1,"../../配置/逐年杀风水师日.txt":G1,"../../配置/逐月杀风水师日.txt":Z1,"../../配置/逐月杀风水师时.txt":H1,"../../配置/造葬杀风水师时.txt":k1,"../../配置/阴阳宅禁日.txt":O1})).filter(([n])=>!n.endsWith("/神圣纪念与神仙资料.txt")).map(([n,t])=>{const e=n.split("/").pop()??n;return H2(e,t)}).sort((n,t)=>n.文件名.localeCompare(t.文件名,"zh-CN"))}function o5(u){return Object.entries(Object.assign({"../../配置/传统节日.txt":M2,"../../配置/季罗睺日.txt":I1,"../../配置/年罗睺日.txt":m1,"../../配置/斗降日-北斗本命延生真经注.txt":S1,"../../配置/斗降日-太上北斗二十八章经.txt":w1,"../../配置/日吉凶.txt":b2,"../../配置/日宜忌.txt":G2,"../../配置/时辰吉凶.txt":z1,"../../配置/时辰宜忌.txt":p1,"../../配置/时辰神煞.txt":N1,"../../配置/月罗睺日.txt":Y1,"../../配置/本命星官.txt":M1,"../../配置/杀师时.txt":T1,"../../配置/现代时辰宜忌.txt":Z2,"../../配置/神圣纪念与神仙资料.txt":b1,"../../配置/逐年杀风水师日.txt":G1,"../../配置/逐月杀风水师日.txt":Z1,"../../配置/逐月杀风水师时.txt":H1,"../../配置/造葬杀风水师时.txt":k1,"../../配置/阴阳宅禁日.txt":O1})).find(([t])=>t.endsWith(`/${u}`))?.[1]}const E5=["建","除","满","平","定","执","破","危","成","收","开","闭"];function $1(u,n){const t=M.indexOf(u),e=M.indexOf(n);return E5[(e-t+12)%12]}function g5(u,n){return(u%n+n)%n}function h5(u=b2){const n=H2("日吉凶.txt",u);if(n.错误.length>0)throw new Error(n.错误.map(h=>h.信息).join("；"));const t={},e=n.规则.find(h=>h.条件==="值神"),i=n.规则.find(h=>h.条件==="吉"),a=n.规则.find(h=>h.条件==="凶"),F=h=>h.split("、").map(D=>D.trim()).filter(Boolean);for(const h of n.规则){const D=h.条件.match(/^([子丑寅卯辰巳午未申酉戌亥]+)月$/u);if(!D)continue;const l=h.内容.match(/^([子丑寅卯辰巳午未申酉戌亥])日$/u)?.[1];if(!l)throw new Error(`日吉凶配置无法识别“${h.原文}”`);for(const B of[...D[1]])t[B]=l}const r=F(e?.内容??""),E=new Set(F(i?.内容??"")),g=new Set(F(a?.内容??""));if(Object.keys(t).length!==12||r.length!==12||E.size!==6||g.size!==6)throw new Error("日吉凶配置不完整");if(r.some(h=>!E.has(h)&&!g.has(h)))throw new Error("日吉凶值神缺少吉凶分类");return{青龙起日:t,值神:r,吉神:E}}const C5=h5();function D5(u,n=C5){const t=C1(u).月建,e=k0(u).日支,i=n.青龙起日[t],a=n.值神[g5(M.indexOf(e)-M.indexOf(i),12)],F=n.吉神.has(a);return{天神:a,类型:F?"黄道":"黑道",吉凶:F?"吉":"凶"}}const X1="现代黄历宜忌体系";function q2(u){return u==="无"?[]:u.split("、").map(n=>n.trim()).filter(Boolean)}function A5(u=Z2){const n=new Map;u.split(/\r?\n/u).forEach((i,a)=>{const F=i.trim();if(!F||F.startsWith("#"))return;const r=F.match(/^([甲乙丙丁戊己庚辛壬癸][子丑寅卯辰巳午未申酉戌亥])日 ([子丑寅卯辰巳午未申酉戌亥])时：宜：(.+?)；忌：(.+)$/u);if(!r)throw new Error(`现代时辰宜忌第${a+1}行无法识别：${i}`);const E=`${r[1]}-${r[2]}`;if(n.has(E))throw new Error(`现代时辰宜忌重复配置：${E}`);n.set(E,{时宜:q2(r[3]),时忌:q2(r[4])})});const e=Array.from({length:60},(i,a)=>`${P[a%10]}${M[a%12]}`).flatMap(i=>M.map(a=>`${i}-${a}`)).filter(i=>!n.has(i));if(n.size!==720||e.length>0)throw new Error(`现代时辰宜忌配置不完整：已有${n.size}组，缺少${e.slice(0,5).join("、")||"未知组合"}`);return{组合数:n.size,查询(i,a){const F=n.get(`${i}-${a}`);if(!F)throw new Error(`现代时辰宜忌不存在：${i}日${a}时`);return{时宜:[...F.时宜],时忌:[...F.时忌],来源:X1}}}}const B5=A5(),c5=["天乙贵人","天官贵人","福星贵人","喜神","日禄","日马"],l5=new Set(["八风","八专","闭日","不将","成日","丑日","除日","除神","触水龙","大耗","大时","地火","地囊","丁日","定日","伏日","福德","福生","复日","庚日","官日","归忌","亥日","吉期","甲日","建日","劫煞","解神","九焦","九坎","九空","开日","立冬后立春前","临日","六合","六仪","路空","满日","卯日","每月二十三日","每月二十一日","每月六日","每月十二日","每月十九日","每月十五日","每月一日","民日","鸣吠","鸣吠对","母仓","平日","破日","普护","壬日","三合","社日","申日","生气","圣心","时德","收日","守日","霜降后立春前","朔日","死气","死神","巳日","四废","四耗","四忌","四穷","四相","天仓","天德","天德合","天恩","天狗","天后","天火","天吏","天马","天赦","天巫","天喜","天医","天愿","天贼","土符","土府","土王用事后","王日","往亡","望日","危日","未日","五富","五合","五离","五墓","五虚","午日","弦日","咸池","相日","小耗","辛日","续世","血忌","血支","旬空","厌对","乙日","驿马","益后","寅日","游祸","酉日","雨水后立夏前","月德","月德合","月恩","月害","月建","月空","月破","月煞","月刑","月虚","月厌","灾煞","招摇","执日","重日","子日"]);function E2(u){return u==="无"?[]:u.split(/[、,，]/u).map(n=>n.trim()).filter(Boolean)}function Y(u,n,t){return{文件名:u,行号:n?.行号??0,原文:n?.原文??"",信息:t}}function y0(){return P.reduce((u,n)=>(u[n]=[],u),{})}function d5(){return M.reduce((u,n)=>(u[n]=[],u),{})}function _5(u,n){const t=P.reduce((i,a)=>(i[a]="",i),{});if(!u)return t;for(const i of E2(u.内容)){const a=i.match(/^([甲乙丙丁戊己庚辛壬癸])日([甲乙丙丁戊己庚辛壬癸][子丑寅卯辰巳午未申酉戌亥])时$/u);if(!a){n.push(Y("时辰神煞.txt",u,`无法识别五不遇定局“${i}”`));continue}const F=a[1];t[F]&&n.push(Y("时辰神煞.txt",u,`“${F}日”重复配置五不遇`)),t[F]=a[2]}const e=P.filter(i=>!t[i]);return e.length>0&&n.push(Y("时辰神煞.txt",u,`五不遇缺少${e.join("、")}日定局`)),t}function e2(u,n){const t=E2(u.内容).map(e=>e.replace(/时$/u,""));return t.some(e=>!M.includes(e))||new Set(t).size!==t.length?(n.push(Y("时辰神煞.txt",u,"时支列表包含无效或重复内容")),[]):t}function i2(u,n,t){const e=new Set;for(const i of E2(u.内容)){const a=n?i.match(/^([子丑寅卯辰巳午未申酉戌亥])刑([子丑寅卯辰巳午未申酉戌亥])$/u):i.match(/^([子丑寅卯辰巳午未申酉戌亥])([子丑寅卯辰巳午未申酉戌亥])$/u);if(!a){t.push(Y("时辰神煞.txt",u,`无法识别“${i}”`));continue}const F=n?`${a[1]}${a[2]}`:[a[1],a[2]].sort().join("");e.has(F)&&t.push(Y("时辰神煞.txt",u,`“${i}”重复配置`)),e.add(F)}return e}function x5(u,n,t,e,i){const a=[...n];if(a.length===0||a.some(F=>!P.includes(F))){i.push(Y("时辰神煞.txt",e,"日干条件无效"));return}for(const F of a)u[F].length>0&&i.push(Y("时辰神煞.txt",e,`“${F}日”重复配置`)),u[F]=t}function y5(u){if(!u)return{配置:null,错误:[Y("时辰神煞.txt",null,"缺少配置文件")]};const n=[...u.错误],t=u.规则.map(w=>w.原文).join(`
`);/[戍]/u.test(t)&&n.push(Y("时辰神煞.txt",null,"发现地支“戍”，应为“戌”")),/[已]/u.test(t)&&n.push(Y("时辰神煞.txt",null,"发现天干“已”，应为“己”"));const e=w=>{const v=u.规则.filter(e0=>e0.条件===w);return v.length!==1&&n.push(Y("时辰神煞.txt",v[1]??null,`“${w}”必须且只能配置一次`)),v[0]},i=e("六冲"),a=e("六合"),F=e("六害"),r=e("相刑"),E=e("自刑"),g=e("五不遇"),h=_5(g,n),D=y0(),l=y0(),B=y0(),x=y0(),f=y0(),y=d5(),_=y0(),S={},p=new Set(["六冲","六合","六害","相刑","自刑","五不遇"]);for(const w of u.规则){if(p.has(w.条件))continue;const v=w.条件.match(/^(天乙贵人|天官贵人|福星贵人|喜神|日禄|路空)·([甲乙丙丁戊己庚辛壬癸]+)日$/u);if(v){const A0={天乙贵人:D,天官贵人:l,福星贵人:B,喜神:x,日禄:f,路空:_}[v[1]];x5(A0,v[2],e2(w,n),w,n);continue}const e0=w.条件.match(/^日马·([子丑寅卯辰巳午未申酉戌亥]+)日$/u);if(e0){for(const X of[...e0[1]])y[X].length>0&&n.push(Y("时辰神煞.txt",w,`“${X}日”重复配置日马`)),y[X]=e2(w,n);continue}const $=w.条件.match(/^旬空·(甲[子戌申午辰寅])旬$/u);if($){S[$[1]]&&n.push(Y("时辰神煞.txt",w,`“${$[1]}旬”重复配置`)),S[$[1]]=e2(w,n);continue}n.push(Y("时辰神煞.txt",w,`未知规则“${w.条件}”`))}for(const[w,v]of Object.entries({天乙贵人:D,天官贵人:l,福星贵人:B,喜神:x,日禄:f,路空:_})){const e0=P.filter($=>v[$].length===0);e0.length>0&&n.push(Y("时辰神煞.txt",null,`${w}缺少${e0.join("、")}日`))}const G=M.filter(w=>y[w].length===0);if(G.length>0&&n.push(Y("时辰神煞.txt",null,`日马缺少${G.join("、")}日`)),["甲子","甲戌","甲申","甲午","甲辰","甲寅"].some(w=>!S[w])&&n.push(Y("时辰神煞.txt",null,"旬空必须完整配置六旬")),n.length>0||!i||!a||!F||!r||!E)return{配置:null,错误:n};const k=new Set(e2({...E,内容:E.内容.split(/[、,，]/u).map(w=>`${w}时`).join("、")},n));return{配置:{六冲:i2(i,!1,n),六合:i2(a,!1,n),六害:i2(F,!1,n),相刑:i2(r,!0,n),自刑:k,天乙贵人:D,天官贵人:l,福星贵人:B,喜神:x,日禄:f,日马:y,旬空:S,路空:_,五不遇:h},错误:n}}function L1(u,n="时辰宜忌.txt"){if(!u)return{配置:null,错误:[Y(n,null,"缺少配置文件")]};const t=[...u.错误],e=new Map;for(const i of u.规则){i.原文.includes("戍")&&t.push(Y(n,i,"发现地支“戍”，应为“戌”")),i.原文.includes("已日")&&t.push(Y(n,i,"发现天干“已”，应为“己”"));const a=i.条件.match(/^(.+?)(宜|忌)$/u);if(!a){t.push(Y(n,i,"事项必须以“宜”或“忌”结尾"));continue}const F=a[1],r=a[2],E=E2(i.内容);new Set(E).size!==E.length&&t.push(Y(n,i,`“${F}${r}”存在重复条件`));const g=E.filter(D=>!l5.has(D));g.length>0&&t.push(Y(n,i,`未知条件：${g.join("、")}`));const h=e.get(F)??{};h[r]&&t.push(Y(n,i,`“${F}${r}”重复配置`)),h[r]=E,e.set(F,h)}for(const[i,a]of e){(!a.宜||!a.忌)&&t.push(Y(n,null,`“${i}”必须同时配置宜、忌，允许内容写“无”`));const F=(a.宜??[]).filter(r=>(a.忌??[]).includes(r));F.length>0&&t.push(Y(n,null,`“${i}”宜忌重复：${F.join("、")}`))}return e.size<60&&t.push(Y(n,null,`通书六十事配置不足，当前仅${e.size}项`)),t.length>0?{配置:null,错误:t}:{配置:[...e].map(([i,a])=>({名称:i,宜:a.宜??[],忌:a.忌??[]})),错误:[]}}function f5(u){const n=y5(u.find(i=>i.文件名==="时辰神煞.txt")),t=L1(u.find(i=>i.文件名==="时辰宜忌.txt")),e=[...n.错误,...t.错误];return!n.配置||!t.配置||e.length>0?{配置:null,错误:e}:{配置:{神煞:n.配置,用事:t.配置},错误:[]}}function l2(u,n){return[u,n].sort().join("")}function j5(u){const n=P.indexOf(u[0]),t=M.indexOf(u[1]);if(n<0||t<0)return null;const e=Array.from({length:60},(a,F)=>`${P[F%10]}${M[F%12]}`),i=e.indexOf(u);return i<0?null:e[Math.floor(i/10)*10]}function I5(u,n,t,e){const i=new Set(e.filter(g=>g==="旬空"||g==="路空")),a=[],F=[],r=[],E=[];for(const g of u){const h=g.宜.some(l=>i.has(l)),D=g.忌.some(l=>i.has(l));h&&D?(r.push(g.名称),E.push(g.名称)):h?a.push(g.名称):D?F.push(g.名称):E.push(g.名称)}return{时宜:a,时忌:F,冲突:r,未判定用事:E}}function m5(u,n,t,e,i){const a=t[1],r=/^[甲乙丙丁戊己庚辛壬癸][子丑寅卯辰巳午未申酉戌亥]$/u.test(n)&&M.includes(a)?B5.查询(n,a):{时宜:[],时忌:[],来源:X1},E={日时关系:[],吉神:[],凶煞:[],时宜:[],时忌:[],现代时宜:r.时宜,现代时忌:r.时忌,现代来源:r.来源,冲突:[],未判定用事:[],依据:"详细规则配置不可用"};if(!u)return E;const g=n[0],h=n[1],D=t[0],l=t[1];if(!P.includes(g)||!M.includes(h)||!P.includes(D)||!M.includes(l))return E;const B=u.神煞,x=[];h===l&&x.push("日建"),B.六冲.has(l2(h,l))&&x.push("日破"),B.六合.has(l2(h,l))&&x.push("日合"),B.六害.has(l2(h,l))&&x.push("日害"),(B.相刑.has(`${h}${l}`)||h===l&&B.自刑.has(h))&&x.push("日刑");const f=[];for(const G of c5)(G==="日马"?B.日马[h]:B[G][g]).includes(l)&&f.push(G);const y=[];B.五不遇[g]===t&&y.push("五不遇");const _=j5(n);_&&B.旬空[_]?.includes(l)&&y.push("旬空"),B.路空[g].includes(l)&&y.push("路空");const S=I5(u.用事,x,f,y),p=e==="配置错误"||i==="—"?"《钦定协纪辨方书》卷七、卷十一、卷三十二":"《玉匣记·诸日起吉时歌》；《钦定协纪辨方书》卷七、卷十一、卷三十二";return{日时关系:x,吉神:f,凶煞:y,时宜:S.时宜,时忌:S.时忌,现代时宜:r.时宜,现代时忌:r.时忌,现代来源:r.来源,冲突:S.冲突,未判定用事:S.未判定用事,依据:`${p}；项目中文配置保守用时结论`}}const v1=["月建","月破","月厌","月刑","月害","劫煞","灾煞","月煞"];function S5(u=G2){const n=H2("日宜忌.txt",u);if(n.错误.length>0)throw new Error(n.错误.map(i=>i.信息).join("；"));const t={};for(const i of n.规则){const a=i.条件.match(/^([子丑寅卯辰巳午未申酉戌亥])月$/u);if(!a)continue;const F={};for(const r of i.内容.split("、")){const E=r.match(/^(月建|月破|月厌|月刑|月害|劫煞|灾煞|月煞)([子丑寅卯辰巳午未申酉戌亥])$/u);if(!E)throw new Error(`日宜忌配置无法识别“${r}”`);F[E[1]]=E[2]}if(v1.some(r=>!F[r]))throw new Error(`日宜忌缺少${a[1]}月条件`);t[a[1]]=F}const e=L1({...n,规则:n.规则.filter(i=>/(?:宜|忌)$/u.test(i.条件))},"日宜忌.txt");if(Object.keys(t).length!==12||!e.配置||e.错误.length>0)throw new Error(["日宜忌配置不完整",...e.错误.map(i=>i.信息)].join("；"));return{月级条件:t,用事:e.配置}}const w5=S5(),z5={子:"丑",丑:"子",寅:"亥",亥:"寅",卯:"戌",戌:"卯",辰:"酉",酉:"辰",巳:"申",申:"巳",午:"未",未:"午"},p5=[["寅","午","戌"],["巳","酉","丑"],["申","子","辰"],["亥","卯","未"]],N5={1:"每月一日",6:"每月六日",12:"每月十二日",15:"每月十五日",19:"每月十九日",21:"每月二十一日",23:"每月二十三日"};function W2(u,n,t){const e=C0(u.年,n),i=F0(u,e)>=0?e:C0(u.年-1,n);return F0(u,i)>=0&&F0(u,C0(i.年+1,t))<0}function Y5(u,n){const t=Y2(u),e=t.日柱[0],i=t.日支,a=x0(u),F=new Set([`${$1(t.月建,i)}日`,`${e}日`,`${i}日`]);for(const D of v1)n.月级条件[t.月建][D]===i&&F.add(D);z5[t.月建]===i&&F.add("六合"),p5.find(D=>D.includes(t.月建))?.includes(i)&&i!==t.月建&&F.add("三合");const E=N5[a.日];E&&F.add(E),a.日===1&&F.add("朔日"),a.日===15&&F.add("望日"),[7,8,22,23].includes(a.日)&&F.add("弦日"),W2(u,"立冬","立春")&&F.add("立冬后立春前"),W2(u,"霜降","立春")&&F.add("霜降后立春前");const g=C0(u.年,"雨水"),h=C0(u.年,"立夏");return F0(u,g)>=0&&F0(u,h)<0&&F.add("雨水后立夏前"),F}function M5(u,n=w5){const t=Y5(u,n),e=[],i=[],a=[];for(const r of n.用事){const E=r.宜.some(h=>t.has(h)),g=r.忌.some(h=>t.has(h));E&&g?a.push(r.名称):E?e.push(r.名称):g&&i.push(r.名称)}const F=n.用事.length;return{宜:e,忌:i,冲突:a,命中条件:[...t],支持事项数:F,诸事不宜:e.length===0&&i.length===F,诸事皆宜:i.length===0&&e.length===F}}function J1({年柱:u,月柱:n,日柱:t,时柱:e}){return`${u}年　${n}月　${t}日　${e}时`}function T5(u){return u%4===0&&(u%100!==0||u%400===0)}function b5(u){const n=Date.UTC(u.年,0,1),t=Date.UTC(u.年,u.月-1,u.日);return Math.floor((t-n)/864e5)+1}function G5(u){const n=T5(u.年)?366:365,t=u.时+u.分/60+u.秒/3600,e=2*Math.PI*(b5(u)-1+(t-12)/24)/n;return 229.18*(75e-6+.001868*Math.cos(e)-.032077*Math.sin(e)-.014615*Math.cos(2*e)-.040849*Math.sin(2*e))}function Z5(u){if(!Number.isFinite(u)||u<-180||u>180)throw new RangeError("经度必须是 -180 到 180 之间的有效数字");return(u-120)*4}function g2(u,n){const t=Z5(n),e=G5(u),i=t+e;return{北京时间:u,真太阳时:h0(u,i*60),经度修正分钟:t,均时差分钟:e,总修正分钟:i}}function H5(u){const n=u.时*3600+u.分*60+u.秒,t=Math.floor((n+3600)%86400/7200);return M[t]}function U1(u,n){const t=P.indexOf(u[0]),e=M.indexOf(n);if(t<0||e<0)throw new Error("无法根据无效干支计算时柱");const i=t%5*2;return`${P[(i+e)%10]}${n}`}function P1(u,n){const t=n===null?null:g2(u,n),e=t?.真太阳时??u,i=e,{日柱:a,日支:F}=k0(e),r=H5(e);return{北京时间:u,真太阳时:t?.真太阳时??null,最终时间:e,日柱计算时间:i,计算依据:t?"真太阳时":"北京时间（未取得定位）",经度修正分钟:t?.经度修正分钟??null,均时差分钟:t?.均时差分钟??null,总修正分钟:t?.总修正分钟??null,时支:r,时柱:U1(a,r),日柱:a,日支:F}}const q1=["青龙","明堂","天刑","朱雀","金匮","天德","白虎","玉堂","天牢","玄武","司命","勾陈"];function W1(u){return u.split(/[、,，]/u).map(n=>n.trim()).filter(Boolean)}function c0(u,n){return{文件名:"时辰吉凶.txt",行号:u?.行号??0,原文:u?.原文??"",信息:n}}function d2(u,n,t){if(!u)return t.push(c0(null,`缺少“${n}”配置`)),[];const e=W1(u.内容);return e.filter(a=>!q1.includes(a)).length>0||new Set(e).size!==e.length?(t.push(c0(u,`“${n}”包含无效或重复值神`)),[]):e}function k5(u){if(!u)return{配置:null,错误:[c0(null,"缺少配置文件")]};const n=[...u.错误],t={},e=new Set(["值神","吉","凶"]);for(const g of u.规则.filter(h=>!e.has(h.条件))){const h=g.内容.replace(/时$/u,""),D=W1(g.条件).map(l=>l.replace(/日$/u,""));if(!M.includes(h)||D.length===0||D.some(l=>!M.includes(l))){n.push(c0(g,"青龙起时必须使用有效的日支与时支"));continue}for(const l of D)t[l]?n.push(c0(g,`“${l}日”重复配置`)):t[l]=h}const i=M.filter(g=>!t[g]);i.length>0&&n.push(c0(null,`缺少${i.join("、")}日的青龙起时`));const a=d2(u.规则.find(g=>g.条件==="值神"),"值神",n),F=d2(u.规则.find(g=>g.条件==="吉"),"吉",n),r=d2(u.规则.find(g=>g.条件==="凶"),"凶",n);if(a.length!==12||new Set(a).size!==12){const g=u.规则.find(h=>h.条件==="值神")??null;n.push(c0(g,"值神顺序必须完整包含十二值神"))}const E=[...F,...r];return(F.length!==6||r.length!==6||new Set(E).size!==12||q1.some(g=>!E.includes(g)))&&n.push(c0(null,"吉凶分组必须各含六神并完整覆盖十二值神")),n.length>0?{配置:null,错误:n}:{配置:{青龙起时:t,值神顺序:a,吉神:F,凶神:r},错误:[]}}function O5(u,n,t){if(!u)return{值神:"配置错误",吉凶:"—"};const e=M.indexOf(u.青龙起时[n]),i=M.indexOf(t),a=u.值神顺序[(i-e+12)%12];return{值神:a,吉凶:u.吉神.includes(a)?"吉":"凶"}}const $5=["","正月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"];function X5(u,n){return u.find(t=>t.文件名===n)}function L5(u){return u.内容==="无"?[]:u.内容.split(/[、,，]/u).map(n=>n.trim().replace(/时$/u,"")).filter(Boolean)}function _2(u,n,t,e,i){const a=X5(u,t);if(!a||a.错误.length>0)return{名称:n,状态:"配置错误",说明:"配置未能正常读取"};const F=a.规则.find(g=>g.条件===e);if(!F)return{名称:n,状态:"配置错误",说明:`缺少“${e}”规则`};if(F.内容==="无")return{名称:n,状态:"无规则",说明:`${e} · 无此规则`};const r=L5(F),E=r.includes(i);return{名称:n,状态:E?"命中":"未命中",说明:`${e} · 忌${r.join("、")}时 · ${i}时${E?"命中":"未命中"}`}}function R1(u,n,t,e){const i=$5[e];return[_2(u,"杀师时","杀师时.txt",`${n}日`,t),_2(u,"造葬杀风水师时","造葬杀风水师时.txt",`${n}日`,t),i?_2(u,"逐月杀风水师时","逐月杀风水师时.txt",i,t):{名称:"逐月杀风水师时",状态:"配置错误",说明:"农历月份无效"}]}const v5=["","正月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],R2={立春:"春季",立夏:"夏季",立秋:"秋季",立冬:"冬季"},J5=["年","季","月","日"];function Q1(u,n){return u.find(t=>t.文件名===n)}function f0(u,n,t){const e=Q1(u,n);return!e||e.错误.length>0?null:e.规则.find(i=>i.条件===t)??null}function U5(u,n){const t=Q1(u,n);return!!(t&&t.错误.length===0)}function m2(u,n,t=""){return{名称:u,层级:n,状态:"配置错误",条件:t,禁忌值:"",展示文本:`${u} · 配置未能正常读取`,说明:"配置未能正常读取"}}function s2(u,n,t,e,i){if(!t)return m2(u,n,i);const a=t.内容===e;return{名称:u,层级:n,状态:a?"命中":"未命中",条件:i,禁忌值:t.内容,展示文本:`${u} · ${i}忌${t.内容}`,说明:`${t.内容}${a?"命中":"未命中"}`}}function P5(u){const n=[u.年-1,u.年].flatMap(o2).filter(t=>Object.hasOwn(R2,t.名称)).filter(t=>F0(t,u)<=0).sort((t,e)=>F0(e,t))[0];if(!n)throw new Error("无法确定罗睺季节");return R2[n.名称]}function q5(u){const n=u.filter(a=>a.状态==="命中"),t=J5.filter(a=>n.some(F=>F.层级===a)),e=u.some(a=>a.状态==="配置错误"),i=[...new Set(n.map(a=>a.展示文本))];return{命中:n,犯忌层级:t,当日状态:e?"规则配置异常":i.length===0?"当日宜":i.join(`
`)}}function K1(u,n){const t=x0(n),{年柱:e,日柱:i}=Y2(n),a=`${e[1]}年`,F=v5[t.月],r=`${i[1]}日`,E=P5(n),g=s2("年罗睺日","年",f0(u,"年罗睺日.txt",a),`${i}日`,a),h=s2("季罗睺日","季",f0(u,"季罗睺日.txt",E),`${i}日`,E),D=s2("月罗睺日","月",f0(u,"月罗睺日.txt",F),r,F),l="阴阳宅禁日.txt",B=`${F}${t.日名}`,x=U5(u,l),f=x&&!!f0(u,l,B),y=x?{名称:"阴阳宅禁日",层级:"日",状态:f?"命中":"未命中",条件:B,禁忌值:B,展示文本:`阴阳宅禁日 · ${B}`,说明:`${B}${f?"命中":"未命中"}`}:m2("阴阳宅禁日","日",B),_=f0(u,"逐年杀风水师日.txt",a),[S="",p=""]=_?.内容.split(/[；;]/u).map(v=>v.trim())??[],G=!!_&&S===`${i}日`,H=_?{名称:"逐年杀风水师日",层级:"年",状态:G?"命中":"未命中",条件:a,禁忌值:S,展示文本:`逐年杀风水师日 · ${a}忌${S}${p?` · ${p}`:""}`,说明:`${S}${G?"命中":"未命中"}`,...G&&p?{方位:p}:{}}:m2("逐年杀风水师日","年",a),k=s2("逐月杀风水师日","月",f0(u,"逐月杀风水师日.txt",F),r,F),w=[g,h,D,y,H,k];return{规则:w,...q5(w)}}const Q2=6e4;function m0(u){return Date.UTC(u.年,u.月-1,u.日,u.时,u.分,u.秒)}function S2(u){const n=new Date(u);return{年:n.getUTCFullYear(),月:n.getUTCMonth()+1,日:n.getUTCDate(),时:n.getUTCHours(),分:n.getUTCMinutes(),秒:n.getUTCSeconds()}}function W5(u){return S2(Math.round(m0(u)/Q2)*Q2)}function K2(u){return{年:u.年,月:u.月,日:u.日,时:0,分:0,秒:0}}function R5(u,n){const t=m0(u);let e=t-1560*60*1e3,i=t+1560*60*1e3;for(let a=0;a<56&&i-e>1e3;a+=1){const F=Math.floor((e+i)/2e3)*1e3,r=g2(S2(F),n).真太阳时;m0(r)<t?e=F+1e3:i=F}return S2(i)}function Q5(u){const n=u.时>=23?K2(h0(u,3600)):K2(u);return[h0(n,-3600),n,...Array.from({length:12},(t,e)=>h0(n,(e*2+1)*60*60))]}function K5(u,n,t,e,i=null,a=[]){const F=n==="真太阳时"&&t!==null?"真太阳时":"北京时间",r=F==="真太阳时"?g2(u,t).真太阳时:u,E=Q5(r),g=E.map(B=>W5(F==="真太阳时"?R5(B,t):B)),h=["子","子",...M.slice(1)],D=m0(u),l=h.map((B,x)=>{const f=g[x],y=g[x+1],_=h0(y,-60),S=h0(E[x],x<2?1800:3600),{日柱:p,日支:G}=k0(S),H=x0(S).月,k=O5(e,G,B),w=U1(p,B);return{键:x===0?"夜子":x===1?"早子":B,名称:x===0?"夜子":x===1?"早子":`${B}时`,时支:B,时间范围:`${N0(f)}～${N0(_)}`,开始北京时间:f,结束北京时间:_,日柱:p,时柱:w,值神:k.值神,吉凶:k.吉凶,详情:m5(i,p,w,k.值神,k.吉凶),风水禁忌:R1(a,G,B,H),当日风水禁忌:K1(a,S),当前:D>=m0(f)&&D<m0(y)}});return{时间依据:F,项目:[{时支:"子",名称:"子时",时段:l.slice(0,2),当前:l.slice(0,2).some(B=>B.当前)},...M.slice(1).map((B,x)=>{const f=l[x+2];return{时支:B,名称:`${B}时`,时段:[f],当前:f.当前}})]}}function V1(u){const n=x0(u),t=Nn(u),e=Y2(u);return{农历:n,节气:t,年柱:e.年柱,月柱:e.月柱,日柱:e.日柱,月建:e.月建,值星:$1(e.月建,e.日支),日吉凶:D5(u),每日宜忌:M5(u),时柱:null,计算时刻:u}}function nn(u){const n=k5(u.find(e=>e.文件名==="时辰吉凶.txt")),t=f5(u);return{时辰吉凶:n.配置,详细时辰:t.配置,错误:[...n.错误,...t.错误]}}function V5(u,n,t,e,i=nn(e),a=x1(e).配置){const F=n==="真太阳时"&&t!==null?"真太阳时":"北京时间",r=t===null?null:g2(u,t),E=P1(u,F==="真太阳时"?t:null),g=V1(E.最终时间),h=y1(a,g.农历,g.日柱),D=K1(e,E.最终时间),l=J1({年柱:g.年柱,月柱:g.月柱,日柱:g.日柱,时柱:E.时柱}),B=K5(u,F,t,i.时辰吉凶,i.详细时辰,e),f=B.项目.flatMap(y=>y.时段).find(y=>y.当前)?.风水禁忌??R1(e,E.日支,E.时支,g.农历.月);return{时间依据:F,真太阳时结果:r,最终:E,历法结果:g,四柱:l,北斗:h,日级风水禁忌:D,时辰规则:f,十二时辰:B,时辰配置错误:i.错误}}function R0(u){return{模式:"实时",时间:N0(u)}}function nu(u,n){return u.模式==="实时"?R0(n):u}function uu(u){return 6e4-(u%6e4+6e4)%6e4}function tu(u,n=Date.now){let t=!1,e=null;const i=()=>{!t||e!==null||(e=setTimeout(()=>{e=null;const a=n();u(a),i()},uu(n())))};return{启动(){t||(t=!0,i())},停止(){t=!1,e!==null&&clearTimeout(e),e=null},是否运行(){return t}}}const n0={最小日期:"1900-01-01",最大日期:"2100-12-31"};function eu(u,n){const t=u.match(/^(\d{4})-(\d{2})-(\d{2})$/u),e=n.match(/^(\d{2}):(\d{2})$/u);if(!t||!e)return null;const[i,a,F,r,E]=[t[1],t[2],t[3],e[1],e[2]].map(Number),g=new Date(Date.UTC(i,a-1,F,r,E));return g.getUTCFullYear()!==i||g.getUTCMonth()+1!==a||g.getUTCDate()!==F||g.getUTCHours()!==r||g.getUTCMinutes()!==E?null:{年:i,月:a,日:F,时:r,分:E,秒:0}}function iu(u,n,t){if(n==="真太阳时"&&t===null)throw new Error("真太阳时查询缺少出生地经度");const e=P1(u,n==="真太阳时"?t:null),i=V1(e.最终时间),a=J1({年柱:i.年柱,月柱:i.月柱,日柱:i.日柱,时柱:e.时柱});return{输入北京时间:u,最终时间:e.最终时间,时间依据:n,经度:n==="真太阳时"?t:null,年柱:i.年柱,月柱:i.月柱,日柱:i.日柱,时柱:e.时柱,四柱:a,八字:`${i.年柱}　${i.月柱}　${i.日柱}　${e.时柱}`}}function su(u,n,t,e){if(!/^\d{4}-\d{2}-\d{2}$/u.test(u)||!/^\d{2}:\d{2}$/u.test(n))return{成功:!1,提示:"请继续输入完整的公历日期和时间"};if(u<n0.最小日期||u>n0.最大日期)return{成功:!1,提示:`当前历法计算支持范围为 ${n0.最小日期} 至 ${n0.最大日期}`};const i=eu(u,n);if(!i)return{成功:!1,提示:"请输入有效的公历日期和时间"};if(t==="真太阳时"&&e===null)return{成功:!1,提示:"请输入出生地经度，或使用当前定位"};try{return{成功:!0,结果:iu(i,t,e)}}catch{return{成功:!1,提示:`当前历法计算支持范围为 ${n0.最小日期} 至 ${n0.最大日期}`}}}function au(u){return u.时间依据==="北京时间"?[`输入北京时间：${v0(u.输入北京时间)}`]:[`输入北京时间：${v0(u.输入北京时间)}`,`出生地经度：${u.经度?.toFixed(2)}°E`,`真太阳时：${v0(u.最终时间)}`]}function Fu(u){const n=u.宜.length===0&&u.忌.length>0;return{日宜:u.诸事皆宜?["诸事皆宜"]:[...u.宜],日忌:u.诸事不宜||n?["诸事不宜"]:[...u.忌]}}function ru(u,n){return(n?u.find(t=>t.键===n):void 0)??u.find(t=>t.当前)??u[0]}function ou(u,n){return n?null:u}function Eu(){return null}function gu(u){return new Date(u.年,u.月-1,u.日)}function hu(u,n,t,e){const i=gu(e),a=!p0(n,i),F=p0(u,n),r=t.模式==="实时";return{今天:i,所选日期:r&&F?i:u,时间查询:nu(t,e),需要渲染:r||a}}function un(u){return`${u.getFullYear()}-${String(u.getMonth()+1).padStart(2,"0")}-${String(u.getDate()).padStart(2,"0")}`}function tn(u,n,t){const e=u.match(/^(\d{4})-(\d{2})-(\d{2})$/u);if(!e||u<n||u>t)return null;const[i,a,F]=[e[1],e[2],e[3]].map(Number),r=new Date(i,a-1,F);return r.getFullYear()===i&&r.getMonth()===a-1&&r.getDate()===F?r:null}function Cu(u,n,t,e){const i=ln(u,n);return tn(un(i),t,e)}const en="traditional-calendar-theme";function sn(u){return u==="system"||u==="light"||u==="dark"}function Du(u){try{const t=u?.getItem(en)??null??void 0;return sn(t)?t:"system"}catch{return"system"}}function V2(u,n){return u==="system"?n?"dark":"light":u}function Au(u){let n=Du(u.存储),t=V2(n,u.媒体查询.matches),e=!1;const i=()=>{t=V2(n,u.媒体查询.matches),u.根元素.dataset.themePreference=n,u.根元素.dataset.theme=t,u.更新主题色?.(t)},a=()=>{n==="system"&&i()},F=()=>{n==="system"&&!e?(u.媒体查询.addEventListener("change",a),e=!0):n!=="system"&&e&&(u.媒体查询.removeEventListener("change",a),e=!1)};return F(),i(),{get 偏好(){return n},get 实际主题(){return t},设置偏好(r){n=r;try{u.存储?.setItem(en,r)}catch{}F(),i()},销毁(){e&&u.媒体查询.removeEventListener("change",a),e=!1}}}function Bu(){const u=document.querySelector('meta[name="theme-color"]');return Au({根元素:document.documentElement,媒体查询:window.matchMedia("(prefers-color-scheme: dark)"),存储:window.localStorage,更新主题色:n=>u?.setAttribute("content",n==="dark"?"#120b08":"#eadcc1")})}const an=document.querySelector("#app");if(!an)throw new Error("页面初始化失败：找不到应用容器");const R=an,a2=Bu();function Q0(u=H0()){return new Date(u.年,u.月-1,u.日)}const S0=H0();let E0=Q0(S0),O=F2({年:E0.getFullYear(),月:E0.getMonth()},E0),l0=R0(S0),t0="北京时间",W0=null,o0="未定位",w0="尚未定位，当前使用北京时间",K={环境:f1(),状态:"未请求",错误类型:null,错误码:null,纬度:null,经度:null,精度米:null,尝试次数:0},a0=null,Y0=`${S0.年}-${String(S0.月).padStart(2,"0")}-${String(S0.日).padStart(2,"0")}`,M0=N0(S0),J0="北京时间",T0="",U0=!1,_0="",O0=null,K0=!1,V0=!1;const b0=r5(),G0=qn("神圣纪念与神仙资料.txt",o5("神圣纪念与神仙资料.txt")??""),cu=nn(b0),x2=x1(b0),lu=G0.人物.reduce((u,n)=>u+n.纪念事件.length,0)+G0.独立纪念事件.length,du=b0.reduce((u,n)=>u+n.规则.length,0)+G0.人物.length+lu,_u=b0.reduce((u,n)=>u+n.错误.length,0)+G0.错误.length;let w2=null,Fn=[];function rn(){return K={环境:f1(),状态:"请求中",错误类型:null,错误码:null,纬度:null,经度:null,精度米:null,尝试次数:0},F5()}function on(u){if(u.成功){K={...K,状态:"成功",错误类型:null,错误码:null,纬度:u.纬度,经度:u.经度,精度米:u.精度米,尝试次数:u.尝试次数};return}K={...K,状态:"失败",错误类型:u.原因,错误码:u.错误码,纬度:null,经度:null,精度米:null,尝试次数:u.尝试次数}}function Z0(){O0=null,K0=!1,V0=!1}function k2(u){const n=H0();E0=Q0(n),O=F2(O,u),l0=R0(n),a0=null,Z0(),q()}function n1(u){const n=Cu(O.所选日期,u,n0.最小日期,n0.最大日期);n&&k2(n)}function z2(){const u=H0();E0=Q0(u),O=F2(O,E0),l0=R0(u),a0=null,Z0(),q()}function O2(u,n){if(!u){n==="原生选择"?z2():(Z0(),q());return}const t=tn(u,n0.最小日期,n0.最大日期);if(!t){Z0(),q();return}p0(t,Q0())?z2():k2(t)}async function u1(u){if(o0==="定位中")return!1;const n=rn();o0="定位中",w0="正在获取本机位置…",q();const t=await n;return on(t),t.成功?(W0=t.经度,o0="成功",t0="真太阳时",w0=t0==="真太阳时"?"定位成功，当前使用真太阳时":"定位成功，当前使用北京时间",q(),!0):(W0=null,t0="北京时间",o0="失败",w0=j1(t.原因),q(),!1)}function xu(u){const n=Math.round(u*60),t=n>=0?"+":"−",e=Math.abs(n);return`${t}${Math.floor(e/60)}分${String(e%60).padStart(2,"0")}秒`}function yu(u){switch(u){case"已拒绝":return"权限拒绝";case"不可用":return"位置不可用";case"超时":return"超时";case"不支持":return"浏览器不支持";case"非安全连接":return"非安全连接";case"坐标无效":return"坐标无效";case"未知错误":return"未知错误";default:return"无"}}function fu(){const u=K.环境,n=K.状态==="成功"?`
    ...
    <div class="location-diagnostics" data-location-diagnostics>
      ...
      <span data-location-diagnostic-error>错误类型：${yu(K.错误类型)}</span>
      <span data-location-diagnostic-code>错误码：${K.错误码??"无"}</span>
      <span>请求次数：${K.尝试次数}</span>
      ${n}
    </div>`}function b(u){return u.replace(/[&<>"']/gu,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n]??n)}function t1(u){return b(u)}function y2(u,n){return`<button type="button" class="deity-link" data-sacred-commemoration="${n}">${u}</button>`}function ju(u,n){const t=u.名称;if(!T2(u))return b(t);if(!u.人物)return y2(b(t),n);const e=[...new Set([u.人物.主名称,...u.人物.匹配名称])].sort((r,E)=>E.length-r.length||r.localeCompare(E,"zh-CN")),i=[];for(let r=0;r<t.length;){const E=e.find(g=>t.startsWith(g,r));if(!E){r+=1;continue}i.push({开始:r,结束:r+E.length}),r+=E.length}if(i.length===0)return y2(b(t),n);let a=0,F="";for(const r of i){F+=b(t.slice(a,r.开始));const E=b(t.slice(r.开始,r.结束));F+=y2(E,n),a=r.结束}return`${F}${b(t.slice(a))}`}function e1(u,n){return`
    ...
    </div>`}function Iu(u){return Fn=u,`
    <div class="calendar-info-item">
      <h3>神圣纪念</h3>
      <div class="calendar-info-values">${u.length>0?u.map((n,t)=>`<span>${ju(n,t)}</span>`).join(""):'<span class="is-empty">无</span>'}</div>
    </div>`}function f2(u){return u.split(/\r?\n[ \t]*\r?\n/u).map(n=>`<p>${b(n).replace(/\r?\n/gu,"<br>")}</p>`).join("")}function mu(u){return u.startsWith("/")?`/0f25bcf2bbb8a869e712/${u.slice(1)}`:u}function Su(u){const n=u.人物,t=n?.神像?`<figure class="deity-portrait"><img src="${t1(mu(n.神像))}" alt="${t1(n.主名称)}神像"></figure>`:"",e=n?.宝诰?`<section class="deity-section deity-proclamation"><h3>${b(n.宝诰标题||"宝诰")}</h3>${f2(n.宝诰)}</section>`:"",i=n?.简介?`<section class="deity-section deity-introduction"><h3>人物简介</h3>${f2(n.简介)}</section>`:"",a=u.事件.纪念简介?`<section class="deity-section commemoration-introduction"><h3>纪念简介</h3>${f2(u.事件.纪念简介)}</section>`:"",F=n?.宝诰&&n.宝诰出处?`<p class="deity-source">宝诰出处：${b(n.宝诰出处)}</p>`:"",r=n?.主名称||u.名称;return`
    <article class="deity-dialog-card${n?.神像?" has-portrait":" is-text-only"}">
      ...
      <div class="deity-dialog-content">
        <header class="deity-dialog-heading">
          <div><p>神圣纪念详情</p><h2 id="deity-dialog-title">${b(r)}</h2></div>
    ...
    </article>`}function wu(u,n){if(!T2(u))return;const t=R.querySelector("[data-deity-dialog]");t&&(t.innerHTML=Su(u),t.classList.toggle("is-text-only",!u.人物?.神像),w2=n,document.body.classList.add("deity-dialog-open"),t.showModal(),t.querySelector("[data-action='close-deity']")?.focus())}function i1(u){u.open&&u.close()}function s1(u,n,t){const e=n.length>0?n:["无"];return`
    <div class="day-action-group is-${t}">
      <h3>${u}</h3>
      <div class="day-action-tags">${e.map(i=>`<span>${b(i)}</span>`).join("")}</div>
    </div>`}function j2(u,n,t="normal"){const e=Array.isArray(n)?n:[n];return`
    <div class="almanac-core-item is-${t}">
      <h3>${u}</h3>
      <strong>${e.map(i=>`<span>${b(i)}</span>`).join("")}</strong>
    </div>`}function zu(u,n){const t=[{action:"previous-day",label:"上一天",text:"‹"},{action:"today",label:"返回今天",text:"今"},{action:"next-day",label:"下一天",text:"›"}];return`
    ...
    </div>`}function En(u,n){return u.当日状态==="规则配置异常"?[u.当日状态]:u.命中.length>0?u.命中.map(t=>t.展示文本):[n]}function pu(u){const n=u.replace(/；项目中文配置保守用时结论$/u,"");return`
    <footer class="hour-detail-source" aria-label="时辰详情依据">
      <strong>时辰详情依据：</strong>
      <span>${b(n)}；风水禁忌另据项目中文风水规则配置。</span>
    </footer>`}const Nu=[{值:"light",标签:"浅色"},{值:"system",标签:"自动"},{值:"dark",标签:"深色"}];function Yu(){return`
    <div class="theme-switch" role="group" aria-label="页面主题">
      ${Nu.map(u=>`<button type="button" data-theme-preference="${u.值}" aria-pressed="${a2.偏好===u.值}"${a2.偏好===u.值?' class="is-active"':""}>${u.标签}</button>`).join("")}
    </div>`}function Mu(){R.querySelectorAll("[data-theme-preference]").forEach(u=>{const n=u.dataset.themePreference===a2.偏好;u.classList.toggle("is-active",n),u.setAttribute("aria-pressed",String(n))})}const Tu=["北京时间","真太阳时"];function bu(){return`
    <div class="time-basis-switch" role="group" aria-label="时间模式">
      ${Tu.map(u=>`<button type="button" data-time-basis="${u}" aria-pressed="${t0===u}"${t0===u?' class="is-active"':""}${o0==="定位中"?" disabled":""}>${u}</button>`).join("")}
    </div>`}function Gu(u){return`
    ...
    </div>`}function Zu(u){const n=u.时段.some(t=>t.键===a0);return`
    ...
    </div>`}function Hu(u){const n=[...u.详情.时宜.map(t=>`宜${t}`),...u.详情.时忌.map(t=>`忌${t}`)];return z0("古籍用事",n,u.详情.时忌.length>0?"bad":"normal")}function ku(u){return`
    ...
    </section>`}function gn(){const u=T0.trim()===""?null:Number(T0),n=u!==null&&Number.isFinite(u)&&u>=-180&&u<=180?u:null,t=su(Y0,M0,J0,n);return t.成功?`<div class="bazi-result" aria-live="polite">
        <p class="bazi-pillars">${t.结果.四柱}</p>
        <p class="bazi-line"><span>八字</span><strong>${t.结果.八字}</strong></p>
        <ul>${au(t.结果).map(e=>`<li>${b(e)}</li>`).join("")}</ul>
      </div>`:`<p class="bazi-message" aria-live="polite">${b(t.提示)}</p>`}function hn(u){const n=/^(\d{4})-(\d{2})-(\d{2})$/u.exec(u);return n?`${Number(n[1])}年${Number(n[2])}月${Number(n[3])}日`:u||"请选择日期"}function p2(){const u=R.querySelector('[data-picker-value="date"]'),n=R.querySelector('[data-picker-value="time"]');u&&(u.textContent=hn(Y0)),n&&(n.textContent=M0||"请选择时间")}function P0(){const u=R.querySelector("[data-bazi-output]");u&&(u.innerHTML=gn())}function Ou(){return`
      ...
      <div class="bazi-form">
        <label class="bazi-picker-field" for="bazi-birth-date">日期
          <span class="mobile-picker-shell" data-picker-shell="date">
            <span class="mobile-picker-value" data-picker-value="date" aria-hidden="true">${hn(Y0)}</span>
            <input class="mobile-picker-native" id="bazi-birth-date" type="date" data-bazi-date aria-label="生辰日期" min="${n0.最小日期}" max="${n0.最大日期}" value="${Y0}">
          </span>
        </label>
        <label class="bazi-picker-field" for="bazi-birth-time">时间
          <span class="mobile-picker-shell" data-picker-shell="time">
            <span class="mobile-picker-value" data-picker-value="time" aria-hidden="true">${M0||"请选择时间"}</span>
            <input class="mobile-picker-native" id="bazi-birth-time" type="time" data-bazi-time aria-label="生辰时间" value="${M0}">
          </span>
        </label>
        <label>计算依据<select data-bazi-basis>
          <option value="北京时间"${J0==="北京时间"?" selected":""}>北京时间</option>
          <option value="真太阳时"${J0==="真太阳时"?" selected":""}>真太阳时</option>
        </select></label>
        ${J0==="真太阳时"?`
          <label>出生地经度<input type="number" data-bazi-longitude min="-180" max="180" step="0.01" inputmode="decimal" placeholder="例如 116.40" value="${b(T0)}"></label>
          <button type="button" class="bazi-locate" data-action="bazi-locate" ${U0?"disabled":""}>${U0?"定位中…":"使用当前定位"}</button>
        `:""}
      </div>
      ${_0?`<p class="bazi-location-note">${b(_0)}</p>`:""}
      <div class="bazi-output" data-bazi-output>${gn()}</div>
    </section>`}function $u(u){if(!u)return"";const n=En(u.当日风水禁忌,"当日宜");return`
    <section class="hour-detail" aria-label="${u.名称}详细时辰信息">
      ...
      <section class="hour-rule-results" aria-label="风水禁忌速查">
        ...
        <div class="rule-results-grid">${u.风水禁忌.map(Gu).join("")}</div>
      </section>
      ${pu(u.详情.依据)}
    </section>`}async function Xu(){if(U0)return;const u=rn();U0=!0,_0="正在获取当前位置…",q();const n=await u;on(n),U0=!1,n.成功?(T0=n.经度.toFixed(2),_0="定位成功，已填入当前设备经度"):_0=j1(n.原因),q()}function q(){const u=dn(O.年,O.月),n=Vn(O.年,O.月,G0,x2.配置),t=O.所选日期,[e,i]=l0.时间.split(":"),a=o1(t.getFullYear(),t.getMonth()+1,t.getDate(),Number(e),Number(i),0),F=V5(a,t0,W0,b0,cu,x2.配置),{最终:r,历法结果:E,四柱:g,北斗:h,日级风水禁忌:D,真太阳时结果:l,十二时辰:B,时辰配置错误:x}=F,f=_u+x.length+x2.错误.length;t0=F.时间依据;const y=D1(r.最终时间),_=d1(G0,E.农历),S=E.节气?`${E.节气.名称} · ${N0(E.节气)}`:"当日无节气",p=E.节气?.名称??"无",G=l?`${v0(l.真太阳时,!0)}（修正 ${xu(l.总修正分钟)}）`:"未取得定位，暂不计算",H=`${r.日柱计算时间.年}年${r.日柱计算时间.月}月${r.日柱计算时间.日}日`,k=l0.模式==="实时"?"实时更新":"手动查询",w=B.项目.flatMap(X=>X.时段),v=ru(w,a0),e0=un(t),$=Fu(E.每日宜忌);a0&&v?.键!==a0&&(a0=null),R.innerHTML=`
      ...
      <section class="calendar-layout" aria-label="日期核心详情与公历月历">
        <aside class="detail-card" aria-label="所选日期核心详情" aria-live="polite">
          ...
          <section class="almanac-core-row" aria-label="日吉凶值日与风水禁忌">
            ${j2("日吉凶",`${E.日吉凶.天神} · ${E.日吉凶.类型} · ${E.日吉凶.吉凶}`,E.日吉凶.吉凶)}
            ${j2("值日",`${E.值星}日`)}
            ${j2("风水禁忌",En(D,"无"),D.命中.length>0?"凶":"normal")}
          </section>
          ...
          <section class="hour-overview" aria-label="十二时辰">
            ...
            ${$u(v)}
            <div class="hour-grid">${B.项目.map(Zu).join("")}</div>
          </section>
        </aside>
        ...
        <div class="calendar-right">
          ...
          <div class="week-row" role="row">
            ${Bn.map((X,A0)=>`<span role="columnheader" title="${C2[A0]}">${X}</span>`).join("")}
          </div>

          <div class="days-grid" role="grid" aria-label="${O.年}年${O.月+1}月">
            ${u.map(X=>{if(X===null)return'<span class="empty-day" aria-hidden="true"></span>';const A0=new Date(O.年,O.月,X),B0=n[X-1],n2=p0(A0,E0),X2=p0(A0,t),h2=[...B0.传统节日,...B0.神圣纪念,...B0.斗降],Cn=h2.length>0?`，${h2.join("、")}`:"",Dn=b(`${_n(A0)}，${C2[A0.getDay()]}，农历${B0.农历.显示}${Cn}${n2?"，今天":""}`);return`
                  <button
                    type="button"
                    class="day-button${n2?" is-today":""}${X2?" is-selected":""}"
                    data-day="${X}"
                    role="gridcell"
                    aria-label="${Dn}"
                    ${n2?'aria-current="date"':""}
                    ${X2?'aria-selected="true"':'aria-selected="false"'}
                  >
                    <span class="solar-day">${X}</span>
                    <span class="lunar-day">${B0.农历摘要}</span>
                    <span class="day-events" title="${b(h2.join("、"))}">
                      ${B0.显示事件.map(An=>`<span class="day-event">${b(An)}</span>`).join("")}
                      ${B0.其余事件数>0?`<span class="day-event day-event-more">另${B0.其余事件数}项</span>`:""}
                    </span>
                    ${n2?'<small class="today-mark">今</small>':""}
                  </button>`}).join("")}
          </div>
          </article>
          ${Ou()}
        ...
        <section class="calculation-card" aria-label="时间与计算依据">
          <div class="time-controls">
            ...
            <p class="location-status is-${o0}" aria-live="polite">${w0}</p>
          </div>

          <details class="calculation-details">
            <summary>计算详情</summary>
            <dl class="calculation-list">
              <div><dt>北京时间</dt><dd>${v0(r.北京时间)}</dd></div>
              <div><dt>真太阳时</dt><dd>${G}</dd></div>
              <div><dt>计算依据</dt><dd>${t0}（${k}）</dd></div>
              <div><dt>历法日</dt><dd>${H}</dd></div>
              <div><dt>节气</dt><dd>${S}</dd></div>
              <div><dt>定位环境</dt><dd>${fu()}</dd></div>
              <div><dt>版本</dt><dd data-app-version>fe2fd1b</dd></div>
            </dl>
            <p class="calculation-note">当前统一按${t0}计算；23:00进入子时，日柱仍在00:00换日</p>
          </details>

          <p class="config-status${f>0?" has-error":""}">
            规则配置：已读取 ${b0.length+1} 个文件 · ${du} 条规则${f>0?` · ${f} 条待修正`:""}
          </p>
        </section>
      </section>
  ...
  `}R.addEventListener("input",u=>{const n=u.target.closest("[data-calendar-date]");if(n){O0=n.value,K0=!0;return}});R.addEventListener("change",u=>{const n=u.target;if(n.matches("[data-calendar-date]"))O0=n.value,V0||O2(n.value,"原生选择");else if(n.matches("[data-bazi-date]"))Y0=n.value,p2(),P0();else if(n.matches("[data-bazi-time]"))M0=n.value,p2(),P0();else if(n.matches("[data-bazi-basis]"))J0=n.value==="真太阳时"?"真太阳时":"北京时间",_0="",q();else if(n.matches("[data-bazi-longitude]"))T0=n.value,_0="",P0();else return});R.addEventListener("input",u=>{const n=u.target;if(n.matches("[data-bazi-date]"))Y0=n.value;else if(n.matches("[data-bazi-time]"))M0=n.value;else if(n.matches("[data-bazi-longitude]"))T0=n.value;else return;p2(),P0()});R.addEventListener("focusout",u=>{const n=u.target;if(n.matches("[data-calendar-date]")){const t=V0;K0=!1,t?O2(O0??n.value,"键盘"):Z0()}else n.matches("[data-bazi-longitude]")&&P0()});R.addEventListener("focusin",u=>{const n=u.target;n.matches("[data-calendar-date]")&&(K0=!0,O0=n.value)});R.addEventListener("pointerdown",u=>{u.target.matches("[data-calendar-date]")&&(V0=!1)});R.addEventListener("keydown",u=>{const n=u.target;if(n.matches("[data-calendar-date]")){if(u.key==="Enter"){u.preventDefault(),O2(O0??n.value,"键盘");return}if(u.key==="Escape"){u.preventDefault(),Z0(),q();return}(/^\d$/u.test(u.key)||["Backspace","Delete","ArrowUp","ArrowDown"].includes(u.key))&&(V0=!0)}});R.addEventListener("click",async u=>{const n=u.target,t=n.closest("[data-deity-dialog]");if(t&&n===t){i1(t);return}const e=n.closest("button");if(!e)return;if(e.dataset.action==="close-deity"){const E=e.closest("[data-deity-dialog]");E&&i1(E);return}const i=e.dataset.sacredCommemoration;if(i!==void 0){const E=Fn[Number(i)];E&&wu(E,e);return}if(sn(e.dataset.themePreference)){a2.设置偏好(e.dataset.themePreference),Mu();return}const a=e.dataset.timeBasis;if(a==="北京时间"||a==="真太阳时"){if(a===t0)return;a==="北京时间"?(t0="北京时间",w0=W0===null?"当前使用北京时间":"定位成功，当前使用北京时间",q()):W0!==null?(t0="真太阳时",o0="成功",w0="定位成功，当前使用真太阳时",q()):await u1();return}if(e.dataset.action==="bazi-locate"){await Xu();return}const F=e.dataset.hourKey;if(F){a0=ou(F,e.classList.contains("is-current")),q();return}if(e.dataset.action==="current-hour"){const E=H0();E0=Q0(E),l0=R0(E),a0=Eu(),q();return}const r=e.dataset.day;if(r){k2(new Date(O.年,O.月,Number(r)));return}switch(e.dataset.action){case"previous-day":n1(-1);break;case"today":z2();break;case"next-day":n1(1);break;case"back-to-top":window.scrollTo({top:0,behavior:"smooth"});break;case"locate":await u1();break}});R.addEventListener("close",u=>{!(u.target instanceof HTMLDialogElement)||!u.target.matches("[data-deity-dialog]")||(document.body.classList.remove("deity-dialog-open"),w2?.focus(),w2=null)},!0);q();const $2=tu(u=>{const n=H0(new Date(u)),t=hu(O.所选日期,E0,l0,n);E0=t.今天,p0(O.所选日期,t.所选日期)||(O=F2(O,t.所选日期)),l0=t.时间查询,t.需要渲染&&!K0&&!R.querySelector("[data-deity-dialog][open]")&&q()});$2.启动();window.addEventListener("pagehide",()=>$2.停止());window.addEventListener("pageshow",()=>$2.启动());
