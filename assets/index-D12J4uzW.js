...
十二月十六：尾牙
十二月廿四：祭灶日
`,kn=new Map([["正月",1],["一月",1],["二月",2],["三月",3],["四月",4],["五月",5],["六月",6],["七月",7],["八月",8],["九月",9],["十月",10],["十一月",11],["冬月",11],["十二月",12],["腊月",12]]),On=new Map(["初一","初二","初三","初四","初五","初六","初七","初八","初九","初十","十一","十二","十三","十四","十五","十六","十七","十八","十九","二十","廿一","廿二","廿三","廿四","廿五","廿六","廿七","廿八","廿九","三十"].map((u,n)=>[u,n+1]));function $n(u=H2){let n=null;const t=[];return u.split(/\r?\n/u).forEach((e,i)=>{const a=e.trim();if(a==="# 常用传统节日"){n="常用传统节日";return}if(a==="# 其他传统民俗节日"){n="其他传统民俗节日";return}if(!a||a.startsWith("#"))return;if(!n)throw new Error(`传统节日.txt 第 ${i+1} 行缺少分类标题`);const F=a.match(/^((?:正|一|二|三|四|五|六|七|八|九|十|十一|十二|冬|腊)月)(初一|初二|初三|初四|初五|初六|初七|初八|初九|初十|十一|十二|十三|十四|十五|十六|十七|十八|十九|二十|廿一|廿二|廿三|廿四|廿五|廿六|廿七|廿八|廿九|三十)[：:](.+)$/u);if(!F)throw new Error(`传统节日.txt 第 ${i+1} 行格式无法识别：${a}`);const r=kn.get(F[1]),g=On.get(F[2]),E=F[3].split(/[、，,]/u).map(h=>h.trim()).filter(Boolean);if(!r||!g||E.length===0)throw new Error(`传统节日.txt 第 ${i+1} 行内容不完整：${a}`);t.push({分类:n,月:r,日:g,名称:E})}),t}const Xn=$n();function B2(u,n){return c1(u,n)}function Q2(u){const n=$0(u).日柱[0];let t=q.indexOf("戊")-q.indexOf(n);return t<0&&(t+=10),C0(u,(t+40)*86400)}function Ln(u,n,t){const e=[],i=[];if(!n.是否闰月)for(const F of Xn){if(F.月!==n.月||F.日!==n.日)continue;(F.分类==="常用传统节日"?e:i).push(...F.名称)}n.月===12&&n.日>=29&&n.年!==t.年&&e.push("除夕");const a=D0(u.年,"清明");return B2(u,C0(a,-86400))&&i.push("寒食节"),B2(u,Q2(D0(u.年,"立春")))&&i.push("春社"),B2(u,Q2(D0(u.年,"立秋")))&&i.push("秋社"),{常用传统节日:e,其他传统民俗节日:i,全部:[...new Set([...e,...i])]}}function f0(u){const n=A1(u).getLunar(),t=n.getMonth()<0,e=`${n.getMonthInChinese()}月`,i=n.getDayInChinese();return{年:n.getYear(),月:Math.abs(n.getMonth()),日:n.getDay(),是否闰月:t,月名:e,日名:i,显示:`${e}${i}`}}function vn(u){return Ln(u,f0(u),f0(C0(u,86400)))}function d1(u){return vn(u).全部}const _1=["匹配名称","神像","宝诰标题","宝诰出处","宝诰版本说明"],Jn=["简介出处","参校来源"],Un=[..._1,...Jn],l2=new Map([["正月",1],["一月",1],["二月",2],["三月",3],["四月",4],["五月",5],["六月",6],["七月",7],["八月",8],["九月",9],["十月",10],["十一月",11],["冬月",11],["十二月",12],["腊月",12]]),d2=new Map(["初一","初二","初三","初四","初五","初六","初七","初八","初九","初十","十一","十二","十三","十四","十五","十六","十七","十八","十九","二十","廿一","廿二","廿三","廿四","廿五","廿六","廿七","廿八","廿九","三十"].map((u,n)=>[u,n+1]));function x1(u,n){return u.slice(0,n).split(/\r?\n/u).length}function Pn(u,n){return u.match(new RegExp(`^${n}：(.*)$`,"mu"))?.[1].trim()??null}function y0(u,n){return u.match(new RegExp(`^${n}：(.*)$`,"mu"))?.[1].trim()??null}function w2(u,n,t){const e=u.match(new RegExp(`^【${n}】[ \\t]*\\r?\\n([\\s\\S]*?)^【${t}】[ \\t]*$`,"mu"));return e?e[1].replace(/^(?:[ \t]*\r?\n)+/u,"").replace(/(?:\r?\n[ \t]*)+$/u,""):null}function qn(u){return u.split("；").map(n=>n.trim()).filter(Boolean)}function Wn(u){const n=[...d2.keys()].join("|"),t=[...l2.keys()].sort((g,E)=>E.length-g.length).join("|"),e=u.match(new RegExp(`^农历(${t})(${n})(?:至(?:(${t}))?(${n}))?$`,"u"));if(!e)return null;const i=l2.get(e[1]),a=d2.get(e[2]),F=e[3]?l2.get(e[3]):i,r=e[4]?d2.get(e[4]):a;return!i||!a||!F||!r||i!==F||a>r?null:{原文:u,月:i,起始日:a,结束日:r}}function f1(u,n,t,e,i){const a=y0(t,"日期"),F=y0(t,"名称"),r=y0(t,"类型"),g=y0(t,"详情人物")??"",E=y0(t,"神像")??"",h=w2(t,"纪念简介开始","纪念简介结束")??"",D=y0(t,"纪念简介出处")??"",l=x1(n,e);if(!a||!F||!r)return i.push({文件名:u,行号:l,信息:"纪念事件必须完整填写日期、名称和类型"}),null;const c=Wn(a);return c?{日期:c,名称:F,类型:r,详情人物名称:g,神像:E,纪念简介:h,纪念简介出处:D}:(i.push({文件名:u,行号:l,信息:`纪念事件日期格式无法解析：${a}`}),null)}function Rn(u,n,t,e,i){const a=[],F=/^【纪念事件】[ \t]*\r?\n([\s\S]*?)^【纪念结束】[ \t]*$/gmu;let r;for(;(r=F.exec(t))!==null;){const g=f1(u,n,r[1],e+r.index,i);g&&a.push(g)}return a}function Qn(u){return!!(u.神像||u.宝诰||u.简介)}function k2(u){return!!(u.事件.纪念简介||u.人物&&Qn(u.人物))}function Kn(u,n){const t={文件名:u,人物:[],独立纪念事件:[],错误:[]},e=/^【人物：([^】\r\n]+)】[ \t]*\r?\n([\s\S]*?)^【人物结束】[ \t]*$/gmu,i=new Map,a=new Map;let F;for(;(F=e.exec(n))!==null;){const _=F[1].trim(),p=F[2],z=x1(n,F.index),G=i.get(_);if(G!==void 0){t.错误.push({文件名:u,行号:z,信息:`人物主名称“${_}”重复，首次出现在第 ${G} 行`});continue}i.set(_,z);const H=Object.fromEntries(Un.map(X=>[X,Pn(p,X)]));for(const X of _1)H[X]===null&&t.错误.push({文件名:u,行号:z,信息:`人物“${_}”缺少“${X}”字段`});const O=w2(p,"宝诰开始","宝诰结束"),S=w2(p,"简介开始","简介结束");O===null&&t.错误.push({文件名:u,行号:z,信息:`人物“${_}”缺少完整宝诰区块`}),S===null&&t.错误.push({文件名:u,行号:z,信息:`人物“${_}”缺少完整简介区块`});const J={主名称:_,匹配名称:qn(H.匹配名称??""),纪念事件:Rn(u,n,p,F.index,t.错误),神像:H.神像??"",宝诰标题:H.宝诰标题??"",宝诰出处:H.宝诰出处??"",宝诰版本说明:H.宝诰版本说明??"",宝诰:O??"",简介:S??"",简介出处:H.简介出处??"",参校来源:H.参校来源??""},i0=[...new Set([J.主名称,...J.匹配名称])];for(const X of i0){const L=a.get(X);L&&L.主名称!==_?t.错误.push({文件名:u,行号:z,信息:`匹配名称“${X}”同时属于“${L.主名称}”与“${_}”（首次出现在第 ${L.行号} 行）`}):a.set(X,{主名称:_,行号:z})}t.人物.push(J)}const r=/^【独立纪念事件】[ \t]*\r?\n([\s\S]*?)^【独立纪念结束】[ \t]*$/gmu;for(;(F=r.exec(n))!==null;){const _=f1(u,n,F[1],F.index,t.错误);_&&t.独立纪念事件.push(_)}const g=n.match(/^【人物：/gmu)?.length??0,E=n.match(/^【人物结束】[ \t]*$/gmu)?.length??0,h=n.match(/^【纪念事件】[ \t]*$/gmu)?.length??0,D=n.match(/^【纪念结束】[ \t]*$/gmu)?.length??0,l=n.match(/^【独立纪念事件】[ \t]*$/gmu)?.length??0,c=n.match(/^【独立纪念结束】[ \t]*$/gmu)?.length??0;g===0&&t.错误.push({文件名:u,行号:1,信息:"未找到任何人物区块"}),(g!==t.人物.length||E!==g)&&t.错误.push({文件名:u,行号:1,信息:"存在未闭合或格式不正确的人物区块"});const x=t.人物.reduce((_,p)=>_+p.纪念事件.length,0);(h!==D||h!==x)&&t.错误.push({文件名:u,行号:1,信息:"存在未归属人物或格式不正确的纪念事件块"}),(l!==c||l!==t.独立纪念事件.length)&&t.错误.push({文件名:u,行号:1,信息:"存在格式不正确的独立纪念事件块"});const y=new Map,f=[...t.人物.flatMap(_=>_.纪念事件.map(p=>({事件:p,归属:_.主名称}))),...t.独立纪念事件.map(_=>({事件:_,归属:"独立纪念"}))];for(const{事件:_,归属:p}of f){const z=`${_.日期.原文}\0${_.名称}\0${_.类型}`,G=y.get(z);G?t.错误.push({文件名:u,行号:1,信息:`纪念事件“${_.名称}”重复出现在“${G}”与“${p}”`}):y.set(z,p),_.详情人物名称&&!i.has(_.详情人物名称)&&t.错误.push({文件名:u,行号:1,信息:`纪念事件“${_.名称}”引用了不存在的人物“${_.详情人物名称}”`})}for(const _ of y1(t))k2(_)||t.错误.push({文件名:u,行号:1,信息:`纪念事件“${_.事件.日期.原文} ${_.名称}”缺少神像、宝诰、人物简介或纪念简介`});return t}function y1(u){if(!u)return[];const n=new Map(u.人物.map(t=>[t.主名称,t]));return[...u.人物.flatMap(t=>t.纪念事件.map(e=>({名称:e.名称,类型:e.类型,人物:e.详情人物名称?n.get(e.详情人物名称)??null:t,事件:e}))),...u.独立纪念事件.map(t=>({名称:t.名称,类型:t.类型,人物:t.详情人物名称?n.get(t.详情人物名称)??null:null,事件:t}))]}function j1(u,n){if(!u||n.是否闰月)return[];const t=e=>e.日期.月===n.月&&n.日>=e.日期.起始日&&n.日<=e.日期.结束日;return y1(u).filter(e=>t(e.事件))}const Vn="《太上北斗二十八章经》",_2="《太上玄灵北斗本命延生真经注》",n5={正月:1,二月:2,三月:3,四月:4,五月:5,六月:6,七月:7,八月:8,九月:9,十月:10,十一月:11,十二月:12};function I1(u){const n={一:1,二:2,三:3,四:4,五:5,六:6,七:7,八:8,九:9};return u==="初十"||u==="十"?10:u==="二十"?20:u==="三十"?30:u.startsWith("初")?n[u.slice(1)]??null:u.startsWith("十")?10+(n[u.slice(1)]??0):u.startsWith("廿")?20+(n[u.slice(1)]??0):null}function h0(u,n,t,e){return{文件名:u,行号:n,原文:t,信息:e}}function K2(u,n,t){const e={};if(!u)return t.push(h0(n,0,"","缺少配置文件")),e;t.push(...u.错误);for(const i of u.规则){const a=n5[i.条件];if(!a)continue;const F=i.内容.split("、").map(I1);if(F.some(r=>r===null)){t.push(h0(n,i.行号,i.原文,"包含无法识别的农历日期"));continue}e[a]=F}return Object.keys(e).length!==12&&t.push(h0(n,0,"","必须完整配置十二个月")),e}function m1(u){const n=[],t="斗降日-太上北斗二十八章经.txt",e="斗降日-北斗本命延生真经注.txt",i="本命星官.txt",a=u.find(f=>f.文件名===t),F=u.find(f=>f.文件名===e),r=u.find(f=>f.文件名===i),g=K2(a,t,n),E=K2(F,e,n),h=F?.规则.find(f=>f.条件==="每月"),D=F?.规则.find(f=>f.条件==="干支日"),l=F?.规则.find(f=>f.条件==="闰月"),c=h?.内容.split("、").map(I1)??[],x=D?.内容.split("、").filter(Boolean)??[];(c.some(f=>f===null)||c.length!==2)&&n.push(h0(e,h?.行号??0,h?.原文??"","每月规则必须配置初三、廿七")),x.join("、")!=="甲子、庚申"&&n.push(h0(e,D?.行号??0,D?.原文??"","干支日必须配置甲子、庚申")),l?.内容!=="从前月"&&n.push(h0(e,l?.行号??0,l?.原文??"","必须明确配置“闰月从前月”"));const y={};if(!r)n.push(h0(i,0,"","缺少配置文件"));else{n.push(...r.错误);for(const f of r.规则){const _=[...f.条件];if(_.some(p=>!M.includes(p))){n.push(h0(i,f.行号,f.原文,"包含无效地支"));continue}for(const p of _)y[p]=f.内容}}return Object.keys(y).length!==12&&n.push(h0(i,0,"","必须完整覆盖十二出生年支")),n.length>0?{配置:null,错误:n}:{配置:{二十八章经:g,真经注:E,真经注每月:c,真经注干支日:x,出生年支本命星官:y},错误:[]}}function V2(u){return`${u.月名}${u.日名}`}function p1(u,n,t){const e=t;if(!u)return{斗降日:{命中:!1,名称:"无",依据:[],来源显示:""},本命下日:`${e}年生人`,本命星官:"配置错误"};const i=[];!n.是否闰月&&u.二十八章经[n.月]?.includes(n.日)&&i.push({来源:Vn,规则:V2(n)}),u.真经注[n.月]?.includes(n.日)&&i.push({来源:_2,规则:`${n.是否闰月?"闰月从前月·":""}${V2(n)}`}),u.真经注每月.includes(n.日)&&i.push({来源:_2,规则:`每月${n.日名}`}),u.真经注干支日.includes(t)&&i.push({来源:_2,规则:`${t}日`});const F=[...new Set(i.map(g=>g.来源))].join("、"),r=e[1];return{斗降日:{命中:i.length>0,名称:i.length>0?"北斗下降":"无",依据:i,来源显示:F},本命下日:`${e}年生人`,本命星官:u.出生年支本命星官[r]}}function u5(u){return u.日===1?u.月名:u.日名}function t5(u,n,t=[]){const e=[...u,...n,...t],i=e.length<=3?e:e.slice(0,2);return{显示事件:i,其余事件数:Math.max(0,e.length-i.length)}}function e5(u,n,t,e){return Array.from({length:E1(u,n)},(i,a)=>{const F=a+1,r=D1(u,n+1,F),g=f0(r),E=d1(r),h=j1(t,g).map(y=>y.名称),D=$0(r).日柱,c=p1(e??null,g,D).斗降日.命中?["斗降"]:[],x=t5(E,h,c);return{公历日:F,农历:g,农历摘要:u5(g),传统节日:E,神圣纪念:h,斗降:c,...x}})}const i5={enableHighAccuracy:!1,timeout:1e4,maximumAge:3e5},s5={enableHighAccuracy:!0,timeout:15e3,maximumAge:0};function a5(){return typeof navigator>"u"?void 0:navigator.geolocation}function F5(){return typeof window>"u"||window.isSecureContext}function r5(u){return u===1||u===2||u===3?u:null}function o5(u){return u===1?"已拒绝":u===2?"不可用":u===3?"超时":"未知错误"}function g5(u,n){typeof console>"u"||console.warn("[定位诊断] GeolocationPositionError",{code:u.code,message:u.message??"",attempt:n})}function S1(){const u=typeof window<"u",n=typeof navigator<"u";return{HTTPS:!u||window.isSecureContext&&window.location.protocol==="https:",支持定位:n&&!!navigator.geolocation,页面可见:typeof document>"u"||document.visibilityState==="visible"}}function E5(u=a5(),n=F5()){return n?u?new Promise(t=>{let e=!1;const i=F=>{e||(e=!0,t(F))},a=(F,r)=>{try{u.getCurrentPosition(({coords:g})=>{if(!Number.isFinite(g.longitude)||g.longitude<-180||g.longitude>180||!Number.isFinite(g.latitude)||g.latitude<-90||g.latitude>90){i({成功:!1,原因:"坐标无效",错误码:null,尝试次数:F});return}i({成功:!0,经度:g.longitude,纬度:g.latitude,精度米:Number.isFinite(g.accuracy)?g.accuracy:0,尝试次数:F})},g=>{if(g5(g,F),F===1&&(g.code===2||g.code===3)){a(2,s5);return}i({成功:!1,原因:o5(g.code),错误码:r5(g.code),尝试次数:F})},r)}catch{i({成功:!1,原因:"未知错误",错误码:null,尝试次数:F})}};a(1,i5)}):Promise.resolve({成功:!1,原因:"不支持",错误码:null,尝试次数:0}):Promise.resolve({成功:!1,原因:"非安全连接",错误码:null,尝试次数:0})}function w1(u){switch(u){case"已拒绝":return"Safari未允许定位。请检查iPhone 设置 → 隐私与安全性 → 定位服务，以及当前网站的位置权限。";case"不可用":return"Safari暂时无法取得位置，已自动重试；请保持页面可见后重新获取。";case"超时":return"定位超时，已自动重试；请保持页面可见后重新获取。";case"不支持":return"当前浏览器不支持定位。";case"非安全连接":return"当前页面不是安全连接，无法使用定位。";default:return"暂时无法取得位置，请重新获取。"}}const z1=`# 季罗睺日
# 格式：季节：罗睺日
# 季节边界按立春、立夏、立秋、立冬。
...
【宝诰结束】
【简介开始】
正史记张陵在蜀地鹤鸣山传授符书，其道统后传至张衡、张鲁。道教尊张陵为正一道祖天师；本简介仅说明正史可见的早期道教传承线索，不以正史的立场性用语替代宗教信仰解释。
【简介结束】
【人物结束】
...
宝诰标题：葛仙翁宝诰
宝诰出处：《宝诰大全·葛仙翁宝诰》
宝诰版本说明：采用10A。注意：二月十三“葛真君”不是葛玄，而是中元护正丹辉妙道真君葛雍。
【宝诰开始】
...
【宝诰结束】
【简介开始】
丘处机，号长春子，为全真道重要祖师。全真史传记其与马钰、谭处端、刘处玄、王处一、郝大通、孙不二同师王重阳；《长春真人西游记》记其西行谒见成吉思汗并劝止杀。
【简介结束】
【人物结束】
...
【宝诰结束】
【简介开始】
姜太公即吕尚，亦称太公望。 《史记》记其受周文王礼遇，辅佐周室兴起，并为齐国开国始祖；后世常将其奉为兵家、渔业等行业祖师。
【简介结束】
【人物结束】
...
【宝诰结束】
【简介开始】
张三丰，号三丰，明代史传列入方伎人物。 《明史》记其游历武当，明太祖、成祖均曾遣使访求，并明确指出其年代与部分传说“不可考”；本简介不采纳无从核实的生卒说。
【简介结束】
【人物结束】
...
【宝诰结束】
【简介开始】
孙思邈，京兆华原人，唐代医家与道教养生传统的重要人物。《新唐书》载其通晓医药、屡辞征召；其著《备急千金要方》《千金翼方》，后世尊为药王。
【简介结束】
【人物结束】
...
【宝诰结束】
【简介开始】
马钰，号丹阳，为全真道七真之一、王重阳弟子。全真史传记其与孙不二为夫妇，并列其为全真早期重要传人；传世有《洞玄金玉集》等著述。
【简介结束】
【人物结束】
...
【宝诰结束】
【简介开始】
王重阳名喆，是全真道创立者与全真七真的师承核心。其《重阳全真集》《重阳教化集》等保存了早期全真教化文字；后世以“重阳帝君”尊称之。
【简介结束】
【人物结束】
...
【宝诰结束】
【简介开始】
郝大通为全真道七真之一，号广宁，后获“通玄太古真人”之号。全真史传将其列为王重阳门下，并与马钰、谭处端、刘处玄、王处一、丘处机、孙不二同为七真。
【简介结束】
【人物结束】
...
【宝诰结束】
【简介开始】
岳飞，南宋将领。 《宋史·岳飞传》记其抗金军旅、北伐与遇害经过；后世以其忠义形象奉祀，并尊称“精忠岳元帅”。本简介只取正史可核的生平与后世尊称关系。
【简介结束】
【人物结束】
...
神像：/神像/雷霆驱魔大将军雷万春.png
宝诰标题：
宝诰出处：
宝诰版本说明：暂无可靠专属宝诰。
简介出处：《新唐书》卷一九二《忠义中·雷万春传》
【宝诰开始】
...
【宝诰结束】
【简介开始】
王处一号玉阳，是全真道七真之一、王重阳弟子。全真史传列其与马钰、谭处端、刘处玄、郝大通、丘处机、孙不二同为七真；传世有《云光集》。
【简介结束】
【人物结束】
...
【宝诰结束】
【简介开始】
仓颉是中国文字起源传说中的黄帝史官。 《说文解字·叙》称“黄帝之史仓颉初造书契”；此为古代文字起源叙事，不等同于可由现代史学确证的个人传记。
【简介结束】
【人物结束】
...
宝诰出处：
宝诰版本说明：暂无可靠专属宝诰。
简介出处：《旧唐书》卷八九《狄仁杰传》；《新唐书》卷一一五《狄仁杰传》
【宝诰开始】
...
【宝诰结束】
【简介开始】
谭处端号长真，是全真道七真之一、王重阳弟子。全真史传所载封号为“长真云水蕴德真人”，并保存《水云集》等与其相关的全真文献。
【简介结束】
【人物结束】
...
【宝诰结束】
【简介开始】
吴客三真君之一，唐宏，字文明，宋代封上元道化明曜妙感真君。
【简介结束】
【人物结束】


【人物：中元护正丹辉妙道真君】
匹配名称：中元护正丹辉妙道真君；葛雍；葛雍文度；葛真君；二月十三葛真君
【纪念事件】
日期：农历二月十三
名称：中元护正丹辉妙道真君圣诞
类型：圣诞
...
【人物：下元定志符应妙道真君】
匹配名称：下元定志符应妙道真君；周武；周武文刚；下元定志周真君
【纪念事件】
日期：农历十月初一
名称：下元定志符应妙道真君圣诞
类型：圣诞
...
【宝诰结束】
【简介开始】
诸葛亮字孔明，蜀汉丞相。 《三国志·诸葛亮传》记其辅佐刘备、主持蜀汉政务并北伐；后世在忠臣、智者崇祀传统中附会出天枢上相等尊号，本简介不把后世神格化叙事倒置为正史事实。
【简介结束】
【人物结束】
...
【宝诰结束】
【简介开始】
孔子名丘，字仲尼，是春秋末期思想家、教育家。 《史记·孔子世家》记其鲁国仕宦、周游列国与晚年整理、教授诸弟子的传统；“大成至圣先师”为后世尊崇孔子的称号。
【简介结束】
【人物结束】
...
【宝诰结束】
【简介开始】
鲁班即公输班，是先秦以来著名巧匠的代表性人物。 《墨子·公输》记公输盘造械与墨子止楚攻宋事，《孟子·离娄下》以“公输子之巧”比喻高超技艺；后世尊为巧圣仙师与行业祖师。
【简介结束】
【人物结束】
...
【宝诰结束】
【简介开始】
水草马明王为农历六月廿三所纪念的独立神圣，与五显华光大帝马元帅不是同一人物。
【简介结束】
【人物结束】
...
九月初六：阴阳宅禁日
十二月初二：阴阳宅禁日
`;function L2(u,n){const t={文件名:u,规则:[],错误:[]};return n.split(/\r?\n/u).forEach((e,i)=>{const a=i+1,F=e.trim();if(!F||F.startsWith("#"))return;const r=F.indexOf("："),g=F.indexOf(":"),E=[r,g].filter(c=>c>=0),h=E.length>0?Math.min(...E):-1;if(h<0){t.错误.push({文件名:u,行号:a,原文:e,信息:"缺少冒号分隔符"});return}const D=F.slice(0,h).trim(),l=F.slice(h+1).trim();if(!D||!l){t.错误.push({文件名:u,行号:a,原文:e,信息:"冒号两侧都必须有内容"});return}t.规则.push({条件:D,内容:l,行号:a,原文:e})}),t}function h5(){return Object.entries(Object.assign({"../../配置/传统节日.txt":H2,"../../配置/季罗睺日.txt":z1,"../../配置/年罗睺日.txt":N1,"../../配置/斗降日-北斗本命延生真经注.txt":Y1,"../../配置/斗降日-太上北斗二十八章经.txt":M1,"../../配置/日吉凶.txt":O2,"../../配置/日宜忌.txt":$2,"../../配置/时辰吉凶.txt":b1,"../../配置/时辰宜忌.txt":T1,"../../配置/时辰神煞.txt":G1,"../../配置/月罗睺日.txt":Z1,"../../配置/本命星官.txt":H1,"../../配置/杀师时.txt":k1,"../../配置/现代时辰宜忌.txt":X2,"../../配置/神圣纪念与神仙资料.txt":O1,"../../配置/逐年杀风水师日.txt":$1,"../../配置/逐月杀风水师日.txt":X1,"../../配置/逐月杀风水师时.txt":L1,"../../配置/造葬杀风水师时.txt":v1,"../../配置/阴阳宅禁日.txt":J1})).filter(([n])=>!n.endsWith("/神圣纪念与神仙资料.txt")).map(([n,t])=>{const e=n.split("/").pop()??n;return L2(e,t)}).sort((n,t)=>n.文件名.localeCompare(t.文件名,"zh-CN"))}function C5(u){return Object.entries(Object.assign({"../../配置/传统节日.txt":H2,"../../配置/季罗睺日.txt":z1,"../../配置/年罗睺日.txt":N1,"../../配置/斗降日-北斗本命延生真经注.txt":Y1,"../../配置/斗降日-太上北斗二十八章经.txt":M1,"../../配置/日吉凶.txt":O2,"../../配置/日宜忌.txt":$2,"../../配置/时辰吉凶.txt":b1,"../../配置/时辰宜忌.txt":T1,"../../配置/时辰神煞.txt":G1,"../../配置/月罗睺日.txt":Z1,"../../配置/本命星官.txt":H1,"../../配置/杀师时.txt":k1,"../../配置/现代时辰宜忌.txt":X2,"../../配置/神圣纪念与神仙资料.txt":O1,"../../配置/逐年杀风水师日.txt":$1,"../../配置/逐月杀风水师日.txt":X1,"../../配置/逐月杀风水师时.txt":L1,"../../配置/造葬杀风水师时.txt":v1,"../../配置/阴阳宅禁日.txt":J1})).find(([t])=>t.endsWith(`/${u}`))?.[1]}const D5=["建","除","满","平","定","执","破","危","成","收","开","闭"];function U1(u,n){const t=M.indexOf(u),e=M.indexOf(n);return D5[(e-t+12)%12]}function A5(u,n){return(u%n+n)%n}function c5(u=O2){const n=L2("日吉凶.txt",u);if(n.错误.length>0)throw new Error(n.错误.map(h=>h.信息).join("；"));const t={},e=n.规则.find(h=>h.条件==="值神"),i=n.规则.find(h=>h.条件==="吉"),a=n.规则.find(h=>h.条件==="凶"),F=h=>h.split("、").map(D=>D.trim()).filter(Boolean);for(const h of n.规则){const D=h.条件.match(/^([子丑寅卯辰巳午未申酉戌亥]+)月$/u);if(!D)continue;const l=h.内容.match(/^([子丑寅卯辰巳午未申酉戌亥])日$/u)?.[1];if(!l)throw new Error(`日吉凶配置无法识别“${h.原文}”`);for(const c of[...D[1]])t[c]=l}const r=F(e?.内容??""),g=new Set(F(i?.内容??"")),E=new Set(F(a?.内容??""));if(Object.keys(t).length!==12||r.length!==12||g.size!==6||E.size!==6)throw new Error("日吉凶配置不完整");if(r.some(h=>!g.has(h)&&!E.has(h)))throw new Error("日吉凶值神缺少吉凶分类");return{青龙起日:t,值神:r,吉神:g}}const B5=c5();function l5(u,n=B5){const t=l1(u).月建,e=$0(u).日支,i=n.青龙起日[t],a=n.值神[A5(M.indexOf(e)-M.indexOf(i),12)],F=n.吉神.has(a);return{天神:a,类型:F?"黄道":"黑道",吉凶:F?"吉":"凶"}}const P1="现代黄历宜忌体系";function n1(u){return u==="无"?[]:u.split("、").map(n=>n.trim()).filter(Boolean)}function d5(u=X2){const n=new Map;u.split(/\r?\n/u).forEach((i,a)=>{const F=i.trim();if(!F||F.startsWith("#"))return;const r=F.match(/^([甲乙丙丁戊己庚辛壬癸][子丑寅卯辰巳午未申酉戌亥])日 ([子丑寅卯辰巳午未申酉戌亥])时：宜：(.+?)；忌：(.+)$/u);if(!r)throw new Error(`现代时辰宜忌第${a+1}行无法识别：${i}`);const g=`${r[1]}-${r[2]}`;if(n.has(g))throw new Error(`现代时辰宜忌重复配置：${g}`);n.set(g,{时宜:n1(r[3]),时忌:n1(r[4])})});const e=Array.from({length:60},(i,a)=>`${q[a%10]}${M[a%12]}`).flatMap(i=>M.map(a=>`${i}-${a}`)).filter(i=>!n.has(i));if(n.size!==720||e.length>0)throw new Error(`现代时辰宜忌配置不完整：已有${n.size}组，缺少${e.slice(0,5).join("、")||"未知组合"}`);return{组合数:n.size,查询(i,a){const F=n.get(`${i}-${a}`);if(!F)throw new Error(`现代时辰宜忌不存在：${i}日${a}时`);return{时宜:[...F.时宜],时忌:[...F.时忌],来源:P1}}}}const _5=d5(),x5=["天乙贵人","天官贵人","福星贵人","喜神","日禄","日马"],f5=new Set(["八风","八专","闭日","不将","成日","丑日","除日","除神","触水龙","大耗","大时","地火","地囊","丁日","定日","伏日","福德","福生","复日","庚日","官日","归忌","亥日","吉期","甲日","建日","劫煞","解神","九焦","九坎","九空","开日","立冬后立春前","临日","六合","六仪","路空","满日","卯日","每月二十三日","每月二十一日","每月六日","每月十二日","每月十九日","每月十五日","每月一日","民日","鸣吠","鸣吠对","母仓","平日","破日","普护","壬日","三合","社日","申日","生气","圣心","时德","收日","守日","霜降后立春前","朔日","死气","死神","巳日","四废","四耗","四忌","四穷","四相","天仓","天德","天德合","天恩","天狗","天后","天火","天吏","天马","天赦","天巫","天喜","天医","天愿","天贼","土符","土府","土王用事后","王日","往亡","望日","危日","未日","五富","五合","五离","五墓","五虚","午日","弦日","咸池","相日","小耗","辛日","续世","血忌","血支","旬空","厌对","乙日","驿马","益后","寅日","游祸","酉日","雨水后立夏前","月德","月德合","月恩","月害","月建","月空","月破","月煞","月刑","月虚","月厌","灾煞","招摇","执日","重日","子日"]);function h2(u){return u==="无"?[]:u.split(/[、,，]/u).map(n=>n.trim()).filter(Boolean)}function Y(u,n,t){return{文件名:u,行号:n?.行号??0,原文:n?.原文??"",信息:t}}function j0(){return q.reduce((u,n)=>(u[n]=[],u),{})}function y5(){return M.reduce((u,n)=>(u[n]=[],u),{})}function j5(u,n){const t=q.reduce((i,a)=>(i[a]="",i),{});if(!u)return t;for(const i of h2(u.内容)){const a=i.match(/^([甲乙丙丁戊己庚辛壬癸])日([甲乙丙丁戊己庚辛壬癸][子丑寅卯辰巳午未申酉戌亥])时$/u);if(!a){n.push(Y("时辰神煞.txt",u,`无法识别五不遇定局“${i}”`));continue}const F=a[1];t[F]&&n.push(Y("时辰神煞.txt",u,`“${F}日”重复配置五不遇`)),t[F]=a[2]}const e=q.filter(i=>!t[i]);return e.length>0&&n.push(Y("时辰神煞.txt",u,`五不遇缺少${e.join("、")}日定局`)),t}function i2(u,n){const t=h2(u.内容).map(e=>e.replace(/时$/u,""));return t.some(e=>!M.includes(e))||new Set(t).size!==t.length?(n.push(Y("时辰神煞.txt",u,"时支列表包含无效或重复内容")),[]):t}function s2(u,n,t){const e=new Set;for(const i of h2(u.内容)){const a=n?i.match(/^([子丑寅卯辰巳午未申酉戌亥])刑([子丑寅卯辰巳午未申酉戌亥])$/u):i.match(/^([子丑寅卯辰巳午未申酉戌亥])([子丑寅卯辰巳午未申酉戌亥])$/u);if(!a){t.push(Y("时辰神煞.txt",u,`无法识别“${i}”`));continue}const F=n?`${a[1]}${a[2]}`:[a[1],a[2]].sort().join("");e.has(F)&&t.push(Y("时辰神煞.txt",u,`“${i}”重复配置`)),e.add(F)}return e}function I5(u,n,t,e,i){const a=[...n];if(a.length===0||a.some(F=>!q.includes(F))){i.push(Y("时辰神煞.txt",e,"日干条件无效"));return}for(const F of a)u[F].length>0&&i.push(Y("时辰神煞.txt",e,`“${F}日”重复配置`)),u[F]=t}function m5(u){if(!u)return{配置:null,错误:[Y("时辰神煞.txt",null,"缺少配置文件")]};const n=[...u.错误],t=u.规则.map(S=>S.原文).join(`
`);/[戍]/u.test(t)&&n.push(Y("时辰神煞.txt",null,"发现地支“戍”，应为“戌”")),/[已]/u.test(t)&&n.push(Y("时辰神煞.txt",null,"发现天干“已”，应为“己”"));const e=S=>{const J=u.规则.filter(i0=>i0.条件===S);return J.length!==1&&n.push(Y("时辰神煞.txt",J[1]??null,`“${S}”必须且只能配置一次`)),J[0]},i=e("六冲"),a=e("六合"),F=e("六害"),r=e("相刑"),g=e("自刑"),E=e("五不遇"),h=j5(E,n),D=j0(),l=j0(),c=j0(),x=j0(),y=j0(),f=y5(),_=j0(),p={},z=new Set(["六冲","六合","六害","相刑","自刑","五不遇"]);for(const S of u.规则){if(z.has(S.条件))continue;const J=S.条件.match(/^(天乙贵人|天官贵人|福星贵人|喜神|日禄|路空)·([甲乙丙丁戊己庚辛壬癸]+)日$/u);if(J){const c0={天乙贵人:D,天官贵人:l,福星贵人:c,喜神:x,日禄:y,路空:_}[J[1]];I5(c0,J[2],i2(S,n),S,n);continue}const i0=S.条件.match(/^日马·([子丑寅卯辰巳午未申酉戌亥]+)日$/u);if(i0){for(const L of[...i0[1]])f[L].length>0&&n.push(Y("时辰神煞.txt",S,`“${L}日”重复配置日马`)),f[L]=i2(S,n);continue}const X=S.条件.match(/^旬空·(甲[子戌申午辰寅])旬$/u);if(X){p[X[1]]&&n.push(Y("时辰神煞.txt",S,`“${X[1]}旬”重复配置`)),p[X[1]]=i2(S,n);continue}n.push(Y("时辰神煞.txt",S,`未知规则“${S.条件}”`))}for(const[S,J]of Object.entries({天乙贵人:D,天官贵人:l,福星贵人:c,喜神:x,日禄:y,路空:_})){const i0=q.filter(X=>J[X].length===0);i0.length>0&&n.push(Y("时辰神煞.txt",null,`${S}缺少${i0.join("、")}日`))}const G=M.filter(S=>f[S].length===0);if(G.length>0&&n.push(Y("时辰神煞.txt",null,`日马缺少${G.join("、")}日`)),["甲子","甲戌","甲申","甲午","甲辰","甲寅"].some(S=>!p[S])&&n.push(Y("时辰神煞.txt",null,"旬空必须完整配置六旬")),n.length>0||!i||!a||!F||!r||!g)return{配置:null,错误:n};const O=new Set(i2({...g,内容:g.内容.split(/[、,，]/u).map(S=>`${S}时`).join("、")},n));return{配置:{六冲:s2(i,!1,n),六合:s2(a,!1,n),六害:s2(F,!1,n),相刑:s2(r,!0,n),自刑:O,天乙贵人:D,天官贵人:l,福星贵人:c,喜神:x,日禄:y,日马:f,旬空:p,路空:_,五不遇:h},错误:n}}function q1(u,n="时辰宜忌.txt"){if(!u)return{配置:null,错误:[Y(n,null,"缺少配置文件")]};const t=[...u.错误],e=new Map;for(const i of u.规则){i.原文.includes("戍")&&t.push(Y(n,i,"发现地支“戍”，应为“戌”")),i.原文.includes("已日")&&t.push(Y(n,i,"发现天干“已”，应为“己”"));const a=i.条件.match(/^(.+?)(宜|忌)$/u);if(!a){t.push(Y(n,i,"事项必须以“宜”或“忌”结尾"));continue}const F=a[1],r=a[2],g=h2(i.内容);new Set(g).size!==g.length&&t.push(Y(n,i,`“${F}${r}”存在重复条件`));const E=g.filter(D=>!f5.has(D));E.length>0&&t.push(Y(n,i,`未知条件：${E.join("、")}`));const h=e.get(F)??{};h[r]&&t.push(Y(n,i,`“${F}${r}”重复配置`)),h[r]=g,e.set(F,h)}for(const[i,a]of e){(!a.宜||!a.忌)&&t.push(Y(n,null,`“${i}”必须同时配置宜、忌，允许内容写“无”`));const F=(a.宜??[]).filter(r=>(a.忌??[]).includes(r));F.length>0&&t.push(Y(n,null,`“${i}”宜忌重复：${F.join("、")}`))}return e.size<60&&t.push(Y(n,null,`通书六十事配置不足，当前仅${e.size}项`)),t.length>0?{配置:null,错误:t}:{配置:[...e].map(([i,a])=>({名称:i,宜:a.宜??[],忌:a.忌??[]})),错误:[]}}function p5(u){const n=m5(u.find(i=>i.文件名==="时辰神煞.txt")),t=q1(u.find(i=>i.文件名==="时辰宜忌.txt")),e=[...n.错误,...t.错误];return!n.配置||!t.配置||e.length>0?{配置:null,错误:e}:{配置:{神煞:n.配置,用事:t.配置},错误:[]}}function x2(u,n){return[u,n].sort().join("")}function S5(u){const n=q.indexOf(u[0]),t=M.indexOf(u[1]);if(n<0||t<0)return null;const e=Array.from({length:60},(a,F)=>`${q[F%10]}${M[F%12]}`),i=e.indexOf(u);return i<0?null:e[Math.floor(i/10)*10]}function w5(u,n,t,e){const i=new Set(e.filter(E=>E==="旬空"||E==="路空")),a=[],F=[],r=[],g=[];for(const E of u){const h=E.宜.some(l=>i.has(l)),D=E.忌.some(l=>i.has(l));h&&D?(r.push(E.名称),g.push(E.名称)):h?a.push(E.名称):D?F.push(E.名称):g.push(E.名称)}return{时宜:a,时忌:F,冲突:r,未判定用事:g}}function z5(u,n,t,e,i){const a=t[1],r=/^[甲乙丙丁戊己庚辛壬癸][子丑寅卯辰巳午未申酉戌亥]$/u.test(n)&&M.includes(a)?_5.查询(n,a):{时宜:[],时忌:[],来源:P1},g={日时关系:[],吉神:[],凶煞:[],时宜:[],时忌:[],现代时宜:r.时宜,现代时忌:r.时忌,现代来源:r.来源,冲突:[],未判定用事:[],依据:"详细规则配置不可用"};if(!u)return g;const E=n[0],h=n[1],D=t[0],l=t[1];if(!q.includes(E)||!M.includes(h)||!q.includes(D)||!M.includes(l))return g;const c=u.神煞,x=[];h===l&&x.push("日建"),c.六冲.has(x2(h,l))&&x.push("日破"),c.六合.has(x2(h,l))&&x.push("日合"),c.六害.has(x2(h,l))&&x.push("日害"),(c.相刑.has(`${h}${l}`)||h===l&&c.自刑.has(h))&&x.push("日刑");const y=[];for(const G of x5)(G==="日马"?c.日马[h]:c[G][E]).includes(l)&&y.push(G);const f=[];c.五不遇[E]===t&&f.push("五不遇");const _=S5(n);_&&c.旬空[_]?.includes(l)&&f.push("旬空"),c.路空[E].includes(l)&&f.push("路空");const p=w5(u.用事,x,y,f),z=e==="配置错误"||i==="—"?"《钦定协纪辨方书》卷七、卷十一、卷三十二":"《玉匣记·诸日起吉时歌》；《钦定协纪辨方书》卷七、卷十一、卷三十二";return{日时关系:x,吉神:y,凶煞:f,时宜:p.时宜,时忌:p.时忌,现代时宜:r.时宜,现代时忌:r.时忌,现代来源:r.来源,冲突:p.冲突,未判定用事:p.未判定用事,依据:`${z}；项目中文配置保守用时结论`}}const W1=["月建","月破","月厌","月刑","月害","劫煞","灾煞","月煞"];function N5(u=$2){const n=L2("日宜忌.txt",u);if(n.错误.length>0)throw new Error(n.错误.map(i=>i.信息).join("；"));const t={};for(const i of n.规则){const a=i.条件.match(/^([子丑寅卯辰巳午未申酉戌亥])月$/u);if(!a)continue;const F={};for(const r of i.内容.split("、")){const g=r.match(/^(月建|月破|月厌|月刑|月害|劫煞|灾煞|月煞)([子丑寅卯辰巳午未申酉戌亥])$/u);if(!g)throw new Error(`日宜忌配置无法识别“${r}”`);F[g[1]]=g[2]}if(W1.some(r=>!F[r]))throw new Error(`日宜忌缺少${a[1]}月条件`);t[a[1]]=F}const e=q1({...n,规则:n.规则.filter(i=>/(?:宜|忌)$/u.test(i.条件))},"日宜忌.txt");if(Object.keys(t).length!==12||!e.配置||e.错误.length>0)throw new Error(["日宜忌配置不完整",...e.错误.map(i=>i.信息)].join("；"));return{月级条件:t,用事:e.配置}}const Y5=N5(),M5={子:"丑",丑:"子",寅:"亥",亥:"寅",卯:"戌",戌:"卯",辰:"酉",酉:"辰",巳:"申",申:"巳",午:"未",未:"午"},b5=[["寅","午","戌"],["巳","酉","丑"],["申","子","辰"],["亥","卯","未"]],T5={1:"每月一日",6:"每月六日",12:"每月十二日",15:"每月十五日",19:"每月十九日",21:"每月二十一日",23:"每月二十三日"};function u1(u,n,t){const e=D0(u.年,n),i=r0(u,e)>=0?e:D0(u.年-1,n);return r0(u,i)>=0&&r0(u,D0(i.年+1,t))<0}function G5(u,n){const t=Z2(u),e=t.日柱[0],i=t.日支,a=f0(u),F=new Set([`${U1(t.月建,i)}日`,`${e}日`,`${i}日`]);for(const D of W1)n.月级条件[t.月建][D]===i&&F.add(D);M5[t.月建]===i&&F.add("六合"),b5.find(D=>D.includes(t.月建))?.includes(i)&&i!==t.月建&&F.add("三合");const g=T5[a.日];g&&F.add(g),a.日===1&&F.add("朔日"),a.日===15&&F.add("望日"),[7,8,22,23].includes(a.日)&&F.add("弦日"),u1(u,"立冬","立春")&&F.add("立冬后立春前"),u1(u,"霜降","立春")&&F.add("霜降后立春前");const E=D0(u.年,"雨水"),h=D0(u.年,"立夏");return r0(u,E)>=0&&r0(u,h)<0&&F.add("雨水后立夏前"),F}function Z5(u,n=Y5){const t=G5(u,n),e=[],i=[],a=[];for(const r of n.用事){const g=r.宜.some(h=>t.has(h)),E=r.忌.some(h=>t.has(h));g&&E?a.push(r.名称):g?e.push(r.名称):E&&i.push(r.名称)}const F=n.用事.length;return{宜:e,忌:i,冲突:a,命中条件:[...t],支持事项数:F,诸事不宜:e.length===0&&i.length===F,诸事皆宜:i.length===0&&e.length===F}}function R1({年柱:u,月柱:n,日柱:t,时柱:e}){return`${u}年　${n}月　${t}日　${e}时`}function H5(u){return u%4===0&&(u%100!==0||u%400===0)}function k5(u){const n=Date.UTC(u.年,0,1),t=Date.UTC(u.年,u.月-1,u.日);return Math.floor((t-n)/864e5)+1}function O5(u){const n=H5(u.年)?366:365,t=u.时+u.分/60+u.秒/3600,e=2*Math.PI*(k5(u)-1+(t-12)/24)/n;return 229.18*(75e-6+.001868*Math.cos(e)-.032077*Math.sin(e)-.014615*Math.cos(2*e)-.040849*Math.sin(2*e))}function $5(u){if(!Number.isFinite(u)||u<-180||u>180)throw new RangeError("经度必须是 -180 到 180 之间的有效数字");return(u-120)*4}function C2(u,n){const t=$5(n),e=O5(u),i=t+e;return{北京时间:u,真太阳时:C0(u,i*60),经度修正分钟:t,均时差分钟:e,总修正分钟:i}}function X5(u){const n=u.时*3600+u.分*60+u.秒,t=Math.floor((n+3600)%86400/7200);return M[t]}function Q1(u,n){const t=q.indexOf(u[0]),e=M.indexOf(n);if(t<0||e<0)throw new Error("无法根据无效干支计算时柱");const i=t%5*2;return`${q[(i+e)%10]}${n}`}function K1(u,n){const t=n===null?null:C2(u,n),e=t?.真太阳时??u,i=e,{日柱:a,日支:F}=$0(e),r=X5(e);return{北京时间:u,真太阳时:t?.真太阳时??null,最终时间:e,日柱计算时间:i,计算依据:t?"真太阳时":"北京时间（未取得定位）",经度修正分钟:t?.经度修正分钟??null,均时差分钟:t?.均时差分钟??null,总修正分钟:t?.总修正分钟??null,时支:r,时柱:Q1(a,r),日柱:a,日支:F}}const V1=["青龙","明堂","天刑","朱雀","金匮","天德","白虎","玉堂","天牢","玄武","司命","勾陈"];function nn(u){return u.split(/[、,，]/u).map(n=>n.trim()).filter(Boolean)}function l0(u,n){return{文件名:"时辰吉凶.txt",行号:u?.行号??0,原文:u?.原文??"",信息:n}}function f2(u,n,t){if(!u)return t.push(l0(null,`缺少“${n}”配置`)),[];const e=nn(u.内容);return e.filter(a=>!V1.includes(a)).length>0||new Set(e).size!==e.length?(t.push(l0(u,`“${n}”包含无效或重复值神`)),[]):e}function L5(u){if(!u)return{配置:null,错误:[l0(null,"缺少配置文件")]};const n=[...u.错误],t={},e=new Set(["值神","吉","凶"]);for(const E of u.规则.filter(h=>!e.has(h.条件))){const h=E.内容.replace(/时$/u,""),D=nn(E.条件).map(l=>l.replace(/日$/u,""));if(!M.includes(h)||D.length===0||D.some(l=>!M.includes(l))){n.push(l0(E,"青龙起时必须使用有效的日支与时支"));continue}for(const l of D)t[l]?n.push(l0(E,`“${l}日”重复配置`)):t[l]=h}const i=M.filter(E=>!t[E]);i.length>0&&n.push(l0(null,`缺少${i.join("、")}日的青龙起时`));const a=f2(u.规则.find(E=>E.条件==="值神"),"值神",n),F=f2(u.规则.find(E=>E.条件==="吉"),"吉",n),r=f2(u.规则.find(E=>E.条件==="凶"),"凶",n);if(a.length!==12||new Set(a).size!==12){const E=u.规则.find(h=>h.条件==="值神")??null;n.push(l0(E,"值神顺序必须完整包含十二值神"))}const g=[...F,...r];return(F.length!==6||r.length!==6||new Set(g).size!==12||V1.some(E=>!g.includes(E)))&&n.push(l0(null,"吉凶分组必须各含六神并完整覆盖十二值神")),n.length>0?{配置:null,错误:n}:{配置:{青龙起时:t,值神顺序:a,吉神:F,凶神:r},错误:[]}}function v5(u,n,t){if(!u)return{值神:"配置错误",吉凶:"—"};const e=M.indexOf(u.青龙起时[n]),i=M.indexOf(t),a=u.值神顺序[(i-e+12)%12];return{值神:a,吉凶:u.吉神.includes(a)?"吉":"凶"}}const J5=["","正月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"];function U5(u,n){return u.find(t=>t.文件名===n)}function P5(u){return u.内容==="无"?[]:u.内容.split(/[、,，]/u).map(n=>n.trim().replace(/时$/u,"")).filter(Boolean)}function y2(u,n,t,e,i){const a=U5(u,t);if(!a||a.错误.length>0)return{名称:n,状态:"配置错误",说明:"配置未能正常读取"};const F=a.规则.find(E=>E.条件===e);if(!F)return{名称:n,状态:"配置错误",说明:`缺少“${e}”规则`};if(F.内容==="无")return{名称:n,状态:"无规则",说明:`${e} · 无此规则`};const r=P5(F),g=r.includes(i);return{名称:n,状态:g?"命中":"未命中",说明:`${e} · 忌${r.join("、")}时 · ${i}时${g?"命中":"未命中"}`}}function un(u,n,t,e){const i=J5[e];return[y2(u,"杀师时","杀师时.txt",`${n}日`,t),y2(u,"造葬杀风水师时","造葬杀风水师时.txt",`${n}日`,t),i?y2(u,"逐月杀风水师时","逐月杀风水师时.txt",i,t):{名称:"逐月杀风水师时",状态:"配置错误",说明:"农历月份无效"}]}const q5=["","正月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],t1={立春:"春季",立夏:"夏季",立秋:"秋季",立冬:"冬季"},W5=["年","季","月","日"];function tn(u,n){return u.find(t=>t.文件名===n)}function I0(u,n,t){const e=tn(u,n);return!e||e.错误.length>0?null:e.规则.find(i=>i.条件===t)??null}function R5(u,n){const t=tn(u,n);return!!(t&&t.错误.length===0)}function z2(u,n,t=""){return{名称:u,层级:n,状态:"配置错误",条件:t,禁忌值:"",展示文本:`${u} · 配置未能正常读取`,说明:"配置未能正常读取"}}function a2(u,n,t,e,i){if(!t)return z2(u,n,i);const a=t.内容===e;return{名称:u,层级:n,状态:a?"命中":"未命中",条件:i,禁忌值:t.内容,展示文本:`${u} · ${i}忌${t.内容}`,说明:`${t.内容}${a?"命中":"未命中"}`}}function Q5(u){const n=[u.年-1,u.年].flatMap(E2).filter(t=>Object.hasOwn(t1,t.名称)).filter(t=>r0(t,u)<=0).sort((t,e)=>r0(e,t))[0];if(!n)throw new Error("无法确定罗睺季节");return t1[n.名称]}function K5(u){const n=u.filter(a=>a.状态==="命中"),t=W5.filter(a=>n.some(F=>F.层级===a)),e=u.some(a=>a.状态==="配置错误"),i=[...new Set(n.map(a=>a.展示文本))];return{命中:n,犯忌层级:t,当日状态:e?"规则配置异常":i.length===0?"当日宜":i.join(`
`)}}function en(u,n){const t=f0(n),{年柱:e,日柱:i}=Z2(n),a=`${e[1]}年`,F=q5[t.月],r=`${i[1]}日`,g=Q5(n),E=a2("年罗睺日","年",I0(u,"年罗睺日.txt",a),`${i}日`,a),h=a2("季罗睺日","季",I0(u,"季罗睺日.txt",g),`${i}日`,g),D=a2("月罗睺日","月",I0(u,"月罗睺日.txt",F),r,F),l="阴阳宅禁日.txt",c=`${F}${t.日名}`,x=R5(u,l),y=x&&!!I0(u,l,c),f=x?{名称:"阴阳宅禁日",层级:"日",状态:y?"命中":"未命中",条件:c,禁忌值:c,展示文本:`阴阳宅禁日 · ${c}`,说明:`${c}${y?"命中":"未命中"}`}:z2("阴阳宅禁日","日",c),_=I0(u,"逐年杀风水师日.txt",a),[p="",z=""]=_?.内容.split(/[；;]/u).map(J=>J.trim())??[],G=!!_&&p===`${i}日`,H=_?{名称:"逐年杀风水师日",层级:"年",状态:G?"命中":"未命中",条件:a,禁忌值:p,展示文本:`逐年杀风水师日 · ${a}忌${p}${z?` · ${z}`:""}`,说明:`${p}${G?"命中":"未命中"}`,...G&&z?{方位:z}:{}}:z2("逐年杀风水师日","年",a),O=a2("逐月杀风水师日","月",I0(u,"逐月杀风水师日.txt",F),r,F),S=[E,h,D,f,H,O];return{规则:S,...K5(S)}}const e1=6e4;function S0(u){return Date.UTC(u.年,u.月-1,u.日,u.时,u.分,u.秒)}function N2(u){const n=new Date(u);return{年:n.getUTCFullYear(),月:n.getUTCMonth()+1,日:n.getUTCDate(),时:n.getUTCHours(),分:n.getUTCMinutes(),秒:n.getUTCSeconds()}}function V5(u){return N2(Math.round(S0(u)/e1)*e1)}function i1(u){return{年:u.年,月:u.月,日:u.日,时:0,分:0,秒:0}}function nu(u,n){const t=S0(u);let e=t-1560*60*1e3,i=t+1560*60*1e3;for(let a=0;a<56&&i-e>1e3;a+=1){const F=Math.floor((e+i)/2e3)*1e3,r=C2(N2(F),n).真太阳时;S0(r)<t?e=F+1e3:i=F}return N2(i)}function uu(u){const n=u.时>=23?i1(C0(u,3600)):i1(u);return[C0(n,-3600),n,...Array.from({length:12},(t,e)=>C0(n,(e*2+1)*60*60))]}function tu(u,n,t,e,i=null,a=[]){const F=n==="真太阳时"&&t!==null?"真太阳时":"北京时间",r=F==="真太阳时"?C2(u,t).真太阳时:u,g=uu(r),E=g.map(c=>V5(F==="真太阳时"?nu(c,t):c)),h=["子","子",...M.slice(1)],D=S0(u),l=h.map((c,x)=>{const y=E[x],f=E[x+1],_=C0(f,-60),p=C0(g[x],x<2?1800:3600),{日柱:z,日支:G}=$0(p),H=f0(p).月,O=v5(e,G,c),S=Q1(z,c);return{键:x===0?"夜子":x===1?"早子":c,名称:x===0?"夜子":x===1?"早子":`${c}时`,时支:c,时间范围:`${M0(y)}～${M0(_)}`,开始北京时间:y,结束北京时间:_,日柱:z,时柱:S,值神:O.值神,吉凶:O.吉凶,详情:z5(i,z,S,O.值神,O.吉凶),风水禁忌:un(a,G,c,H),当日风水禁忌:en(a,p),当前:D>=S0(y)&&D<S0(f)}});return{时间依据:F,项目:[{时支:"子",名称:"子时",时段:l.slice(0,2),当前:l.slice(0,2).some(c=>c.当前)},...M.slice(1).map((c,x)=>{const y=l[x+2];return{时支:c,名称:`${c}时`,时段:[y],当前:y.当前}})]}}function sn(u){const n=f0(u),t=Tn(u),e=Z2(u);return{农历:n,节气:t,年柱:e.年柱,月柱:e.月柱,日柱:e.日柱,月建:e.月建,值星:U1(e.月建,e.日支),日吉凶:l5(u),每日宜忌:Z5(u),时柱:null,计算时刻:u}}function an(u){const n=L5(u.find(e=>e.文件名==="时辰吉凶.txt")),t=p5(u);return{时辰吉凶:n.配置,详细时辰:t.配置,错误:[...n.错误,...t.错误]}}function eu(u,n,t,e,i=an(e),a=m1(e).配置){const F=n==="真太阳时"&&t!==null?"真太阳时":"北京时间",r=t===null?null:C2(u,t),g=K1(u,F==="真太阳时"?t:null),E=sn(g.最终时间),h=p1(a,E.农历,E.日柱),D=en(e,g.最终时间),l=R1({年柱:E.年柱,月柱:E.月柱,日柱:E.日柱,时柱:g.时柱}),c=tu(u,F,t,i.时辰吉凶,i.详细时辰,e),y=c.项目.flatMap(f=>f.时段).find(f=>f.当前)?.风水禁忌??un(e,g.日支,g.时支,E.农历.月);return{时间依据:F,真太阳时结果:r,最终:g,历法结果:E,四柱:l,北斗:h,日级风水禁忌:D,时辰规则:y,十二时辰:c,时辰配置错误:i.错误}}function Q0(u){return{模式:"实时",时间:M0(u)}}function iu(u,n){return u.模式==="实时"?Q0(n):u}function su(u){return 6e4-(u%6e4+6e4)%6e4}function au(u,n=Date.now){let t=!1,e=null;const i=()=>{!t||e!==null||(e=setTimeout(()=>{e=null;const a=n();u(a),i()},su(n())))};return{启动(){t||(t=!0,i())},停止(){t=!1,e!==null&&clearTimeout(e),e=null},是否运行(){return t}}}const Q={最小日期:"1900-01-01",最大日期:"2100-12-31"};function Fu(u,n){const t=u.match(/^(\d{4})-(\d{2})-(\d{2})$/u),e=n.match(/^(\d{2}):(\d{2})$/u);if(!t||!e)return null;const[i,a,F,r,g]=[t[1],t[2],t[3],e[1],e[2]].map(Number),E=new Date(Date.UTC(i,a-1,F,r,g));return E.getUTCFullYear()!==i||E.getUTCMonth()+1!==a||E.getUTCDate()!==F||E.getUTCHours()!==r||E.getUTCMinutes()!==g?null:{年:i,月:a,日:F,时:r,分:g,秒:0}}function ru(u,n,t){if(n==="真太阳时"&&t===null)throw new Error("真太阳时查询缺少出生地经度");const e=K1(u,n==="真太阳时"?t:null),i=sn(e.最终时间),a=R1({年柱:i.年柱,月柱:i.月柱,日柱:i.日柱,时柱:e.时柱});return{输入北京时间:u,最终时间:e.最终时间,时间依据:n,经度:n==="真太阳时"?t:null,年柱:i.年柱,月柱:i.月柱,日柱:i.日柱,时柱:e.时柱,四柱:a,八字:`${i.年柱}　${i.月柱}　${i.日柱}　${e.时柱}`}}function ou(u,n,t,e){if(!/^\d{4}-\d{2}-\d{2}$/u.test(u)||!/^\d{2}:\d{2}$/u.test(n))return{成功:!1,提示:"请继续输入完整的公历日期和时间"};if(u<Q.最小日期||u>Q.最大日期)return{成功:!1,提示:`当前历法计算支持范围为 ${Q.最小日期} 至 ${Q.最大日期}`};const i=Fu(u,n);if(!i)return{成功:!1,提示:"请输入有效的公历日期和时间"};if(t==="真太阳时"&&e===null)return{成功:!1,提示:"请输入出生地经度，或使用当前定位"};try{return{成功:!0,结果:ru(i,t,e)}}catch{return{成功:!1,提示:`当前历法计算支持范围为 ${Q.最小日期} 至 ${Q.最大日期}`}}}function gu(u){return u.时间依据==="北京时间"?[`输入北京时间：${J0(u.输入北京时间)}`]:[`输入北京时间：${J0(u.输入北京时间)}`,`出生地经度：${u.经度?.toFixed(2)}°E`,`真太阳时：${J0(u.最终时间)}`]}function Eu(u){const n=u.宜.length===0&&u.忌.length>0;return{日宜:u.诸事皆宜?["诸事皆宜"]:[...u.宜],日忌:u.诸事不宜||n?["诸事不宜"]:[...u.忌]}}function hu(u,n){return(n?u.find(t=>t.键===n):void 0)??u.find(t=>t.当前)??u[0]}function Cu(u,n){return n?null:u}function Du(){return null}function Au(u){return new Date(u.年,u.月-1,u.日)}function cu(u,n,t,e){const i=Au(e),a=!Y0(n,i),F=Y0(u,n),r=t.模式==="实时";return{今天:i,所选日期:r&&F?i:u,时间查询:iu(t,e),需要渲染:r||a}}function v2(u){return`${u.getFullYear()}-${String(u.getMonth()+1).padStart(2,"0")}-${String(u.getDate()).padStart(2,"0")}`}function J2(u,n,t){const e=u.match(/^(\d{4})-(\d{2})-(\d{2})$/u);if(!e||u<n||u>t)return null;const[i,a,F]=[e[1],e[2],e[3]].map(Number),r=new Date(i,a-1,F);return r.getFullYear()===i&&r.getMonth()===a-1&&r.getDate()===F?r:null}function Bu(u,n,t,e){const i=fn(u,n);return J2(v2(i),t,e)}function lu(u,n,t,e){const i=new Date(u.getFullYear(),u.getMonth()+n,1),a=new Date(i.getFullYear(),i.getMonth()+1,0).getDate(),F=new Date(i.getFullYear(),i.getMonth(),Math.min(u.getDate(),a));return J2(v2(F),t,e)}const Fn="traditional-calendar-theme";function rn(u){return u==="system"||u==="light"||u==="dark"}function du(u){try{const t=u?.getItem(Fn)??null??void 0;return rn(t)?t:"system"}catch{return"system"}}function s1(u,n){return u==="system"?n?"dark":"light":u}function _u(u){let n=du(u.存储),t=s1(n,u.媒体查询.matches),e=!1;const i=()=>{t=s1(n,u.媒体查询.matches),u.根元素.dataset.themePreference=n,u.根元素.dataset.theme=t,u.更新主题色?.(t)},a=()=>{n==="system"&&i()},F=()=>{n==="system"&&!e?(u.媒体查询.addEventListener("change",a),e=!0):n!=="system"&&e&&(u.媒体查询.removeEventListener("change",a),e=!1)};return F(),i(),{get 偏好(){return n},get 实际主题(){return t},设置偏好(r){n=r;try{u.存储?.setItem(Fn,r)}catch{}F(),i()},销毁(){e&&u.媒体查询.removeEventListener("change",a),e=!1}}}function xu(){const u=document.querySelector('meta[name="theme-color"]');return _u({根元素:document.documentElement,媒体查询:window.matchMedia("(prefers-color-scheme: dark)"),存储:window.localStorage,更新主题色:n=>u?.setAttribute("content",n==="dark"?"#120b08":"#eadcc1")})}const on=document.querySelector("#app");if(!on)throw new Error("页面初始化失败：找不到应用容器");const $=on,r2=xu();function K0(u=O0()){return new Date(u.年,u.月-1,u.日)}const w0=O0();let E0=K0(w0),k=o2({年:E0.getFullYear(),月:E0.getMonth()},E0),d0=Q0(w0),e0="北京时间",R0=null,g0="未定位",z0="尚未定位，当前使用北京时间",V={环境:S1(),状态:"未请求",错误类型:null,错误码:null,纬度:null,经度:null,精度米:null,尝试次数:0},F0=null,b0=`${w0.年}-${String(w0.月).padStart(2,"0")}-${String(w0.日).padStart(2,"0")}`,T0=M0(w0),U0="北京时间",G0="",P0=!1,x0="",X0=null,V0=!1,n2=!1,t0=null,gn=0;const Z0=h5(),H0=Kn("神圣纪念与神仙资料.txt",C5("神圣纪念与神仙资料.txt")??""),fu=an(Z0),j2=m1(Z0),yu=H0.人物.reduce((u,n)=>u+n.纪念事件.length,0)+H0.独立纪念事件.length,ju=Z0.reduce((u,n)=>u+n.规则.length,0)+H0.人物.length+yu,Iu=Z0.reduce((u,n)=>u+n.错误.length,0)+H0.错误.length;let Y2=null,En=[];function hn(){return V={环境:S1(),状态:"请求中",错误类型:null,错误码:null,纬度:null,经度:null,精度米:null,尝试次数:0},E5()}function Cn(u){if(u.成功){V={...V,状态:"成功",错误类型:null,错误码:null,纬度:u.纬度,经度:u.经度,精度米:u.精度米,尝试次数:u.尝试次数};return}V={...V,状态:"失败",错误类型:u.原因,错误码:u.错误码,纬度:null,经度:null,精度米:null,尝试次数:u.尝试次数}}function k0(){X0=null,V0=!1,n2=!1}function D2(u){const n=O0();E0=K0(n),k=o2(k,u),d0=Q0(n),F0=null,k0(),W()}function a1(u){const n=Bu(k.所选日期,u,Q.最小日期,Q.最大日期);n&&D2(n)}function M2(u){const n=lu(k.所选日期,u,Q.最小日期,Q.最大日期);if(!n)return;D2(n);const t=$.querySelector("[data-month-calendar]");!t||window.matchMedia("(prefers-reduced-motion: reduce)").matches||(t.classList.add(u>0?"is-month-transition-next":"is-month-transition-previous"),window.setTimeout(()=>t.classList.remove("is-month-transition-next","is-month-transition-previous"),180))}function b2(){const u=O0();E0=K0(u),k=o2(k,E0),d0=Q0(u),F0=null,k0(),W()}function U2(u,n){if(!u){n==="原生选择"?b2():(k0(),W());return}const t=J2(u,Q.最小日期,Q.最大日期);if(!t){k0(),W();return}Y0(t,K0())?b2():D2(t)}async function F1(u){if(g0==="定位中")return!1;const n=hn();g0="定位中",z0="正在获取本机位置…",W();const t=await n;return Cn(t),t.成功?(R0=t.经度,g0="成功",e0="真太阳时",z0=e0==="真太阳时"?"定位成功，当前使用真太阳时":"定位成功，当前使用北京时间",W(),!0):(R0=null,e0="北京时间",g0="失败",z0=w1(t.原因),W(),!1)}function mu(u){const n=Math.round(u*60),t=n>=0?"+":"−",e=Math.abs(n);return`${t}${Math.floor(e/60)}分${String(e%60).padStart(2,"0")}秒`}function pu(u){switch(u){case"已拒绝":return"权限拒绝";case"不可用":return"位置不可用";case"超时":return"超时";case"不支持":return"浏览器不支持";case"非安全连接":return"非安全连接";case"坐标无效":return"坐标无效";case"未知错误":return"未知错误";default:return"无"}}function Su(){const u=V.环境,n=V.状态==="成功"?`
    ...
    <div class="location-diagnostics" data-location-diagnostics>
      ...
      <span data-location-diagnostic-error>错误类型：${pu(V.错误类型)}</span>
      <span data-location-diagnostic-code>错误码：${V.错误码??"无"}</span>
      <span>请求次数：${V.尝试次数}</span>
      ${n}
    </div>`}function T(u){return u.replace(/[&<>"']/gu,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n]??n)}function F2(u){return T(u)}function I2(u,n){return`<button type="button" class="deity-link" data-sacred-commemoration="${n}">${u}</button>`}function wu(u,n){const t=u.名称;if(!k2(u))return T(t);if(!u.人物)return I2(T(t),n);const e=[...new Set([u.人物.主名称,...u.人物.匹配名称])].sort((r,g)=>g.length-r.length||r.localeCompare(g,"zh-CN")),i=[];for(let r=0;r<t.length;){const g=e.find(E=>t.startsWith(E,r));if(!g){r+=1;continue}i.push({开始:r,结束:r+g.length}),r+=g.length}if(i.length===0)return I2(T(t),n);let a=0,F="";for(const r of i){F+=T(t.slice(a,r.开始));const g=T(t.slice(r.开始,r.结束));F+=I2(g,n),a=r.结束}return`${F}${T(t.slice(a))}`}function r1(u,n){return`
    ...
    </div>`}function zu(u){return En=u,`
    <div class="calendar-info-item">
      <h3>神圣纪念</h3>
      <div class="calendar-info-values">${u.length>0?u.map((n,t)=>`<span>${wu(n,t)}</span>`).join(""):'<span class="is-empty">无</span>'}</div>
    </div>`}function m2(u){return u.split(/\r?\n[ \t]*\r?\n/u).map(n=>`<p>${T(n).replace(/\r?\n/gu,"<br>")}</p>`).join("")}function p2(u){return u.startsWith("/")?`/0f25bcf2bbb8a869e712/${u.slice(1)}`:u}function Nu(u){const n=u.人物,t=n?.神像||u.事件.神像,e=n?.主名称||u.名称,i=t?`<figure class="deity-portrait">
        <img class="deity-portrait-background" src="${F2(p2("/神像/背景.png"))}" alt="" aria-hidden="true" loading="lazy" decoding="async">
        <img class="deity-portrait-subject" src="${F2(p2(t))}" alt="${F2(e)}神像" loading="lazy" decoding="async">
        <img class="deity-portrait-clouds" src="${F2(p2("/神像/祥云前景.png"))}" alt="" aria-hidden="true" loading="lazy" decoding="async">
      </figure>`:"",a=n?.宝诰?`<section class="deity-section deity-proclamation"><h3>${T(n.宝诰标题||"宝诰")}</h3>${m2(n.宝诰)}</section>`:"",F=n?.简介?`<section class="deity-section deity-introduction"><h3>人物简介</h3>${m2(n.简介)}</section>`:"",r=u.事件.纪念简介?`<section class="deity-section commemoration-introduction"><h3>纪念简介</h3>${m2(u.事件.纪念简介)}</section>`:"",g=n?.宝诰&&n.宝诰出处?`<p class="deity-source">宝诰出处：${T(n.宝诰出处)}</p>`:"",E=n?.主名称||u.名称;return`
    <article class="deity-dialog-card${t?" has-portrait":" is-text-only"}">
      ${i}
      <div class="deity-dialog-content">
        <header class="deity-dialog-heading">
          <div><p>神圣纪念详情</p><h2 id="deity-dialog-title">${T(E)}</h2></div>
          <button type="button" class="deity-dialog-close" data-action="close-deity" aria-label="关闭神圣纪念详情">×</button>
        </header>
        <div class="deity-dialog-scroll">${a}${F}${r}${g}</div>
      </div>
    </article>`}function Yu(u,n){if(!k2(u))return;const t=$.querySelector("[data-deity-dialog]");t&&(t.innerHTML=Nu(u),t.classList.toggle("is-text-only",!(u.人物?.神像||u.事件.神像)),Y2=n,document.body.classList.add("deity-dialog-open"),t.showModal(),t.querySelector("[data-action='close-deity']")?.focus())}function o1(u){u.open&&u.close()}function g1(u,n,t){const e=n.length>0?n:["无"];return`
    <div class="day-action-group is-${t}">
      <h3>${u}</h3>
      <div class="day-action-tags">${e.map(i=>`<span>${T(i)}</span>`).join("")}</div>
    </div>`}function S2(u,n,t="normal"){const e=Array.isArray(n)?n:[n];return`
    ...
    </div>`}function Dn(u,n){return u.当日状态==="规则配置异常"?[u.当日状态]:u.命中.length>0?u.命中.map(t=>t.展示文本):[n]}function bu(u){const n=u.replace(/；项目中文配置保守用时结论$/u,"");return`
    ...
    <div class="theme-switch" role="group" aria-label="页面主题">
      ${Tu.map(u=>`<button type="button" data-theme-preference="${u.值}" aria-pressed="${r2.偏好===u.值}"${r2.偏好===u.值?' class="is-active"':""}>${u.标签}</button>`).join("")}
    </div>`}function Zu(){$.querySelectorAll("[data-theme-preference]").forEach(u=>{const n=u.dataset.themePreference===r2.偏好;u.classList.toggle("is-active",n),u.setAttribute("aria-pressed",String(n))})}const Hu=["北京时间","真太阳时"];function ku(){return`
    ...
    </article>`}function N0(u,n,t="normal"){const e=u==="日时关系"?"无特殊关系":"无";return`
    <div class="hour-detail-group is-${t}">
      <dt>${u}</dt>
      <dd>${n.length>0?n.map(i=>`<span>${T(i)}</span>`).join(""):`<em>${e}</em>`}</dd>
    </div>`}function Xu(u){const n=[...u.详情.时宜.map(t=>`宜${t}`),...u.详情.时忌.map(t=>`忌${t}`)];return N0("古籍用事",n,u.详情.时忌.length>0?"bad":"normal")}function Lu(u){return`
    <section class="modern-hour-actions" aria-label="现代时辰宜忌">
      <div class="modern-hour-actions-grid">
        ${N0("时宜",u.详情.现代时宜,"good")}
        ${N0("时忌",u.详情.现代时忌,"bad")}
      </div>
      <small>${u.详情.现代来源}</small>
    </section>`}function An(){const u=G0.trim()===""?null:Number(G0),n=u!==null&&Number.isFinite(u)&&u>=-180&&u<=180?u:null,t=ou(b0,T0,U0,n);return t.成功?`<div class="bazi-result" aria-live="polite">
        <p class="bazi-pillars">${t.结果.四柱}</p>
        <p class="bazi-line"><span>八字</span><strong>${t.结果.八字}</strong></p>
        <ul>${gu(t.结果).map(e=>`<li>${T(e)}</li>`).join("")}</ul>
      </div>`:`<p class="bazi-message" aria-live="polite">${T(t.提示)}</p>`}function cn(u){const n=/^(\d{4})-(\d{2})-(\d{2})$/u.exec(u);return n?`${Number(n[1])}年${Number(n[2])}月${Number(n[3])}日`:u||"请选择日期"}function T2(){const u=$.querySelector('[data-picker-value="date"]'),n=$.querySelector('[data-picker-value="time"]');u&&(u.textContent=cn(b0)),n&&(n.textContent=T0||"请选择时间")}function q0(){const u=$.querySelector("[data-bazi-output]");u&&(u.innerHTML=An())}function vu(){return`
    <section class="bazi-card" aria-label="生辰八字查询">
      ...
      <div class="bazi-form">
        <label class="bazi-picker-field" for="bazi-birth-date">日期
          <span class="mobile-picker-shell" data-picker-shell="date">
            <span class="mobile-picker-value" data-picker-value="date" aria-hidden="true">${cn(b0)}</span>
            <input class="mobile-picker-native" id="bazi-birth-date" type="date" data-bazi-date aria-label="生辰日期" min="${Q.最小日期}" max="${Q.最大日期}" value="${b0}">
          </span>
        </label>
        ...
        ${U0==="真太阳时"?`
          <label>出生地经度<input type="number" data-bazi-longitude min="-180" max="180" step="0.01" inputmode="decimal" placeholder="例如 116.40" value="${T(G0)}"></label>
      ...
      <div class="bazi-output" data-bazi-output>${An()}</div>
    </section>`}function Ju(u){if(!u)return"";const n=Dn(u.当日风水禁忌,"当日宜");return`
    <section class="hour-detail" aria-label="${u.名称}详细时辰信息">
      ...
      ${bu(u.详情.依据)}
    </section>`}async function Uu(){if(P0)return;const u=hn();P0=!0,x0="正在获取当前位置…",W();const n=await u;Cn(n),P0=!1,n.成功?(G0=n.经度.toFixed(2),x0="定位成功，已填入当前设备经度"):x0=w1(n.原因),W()}function W(){const u=yn(k.年,k.月),n=e5(k.年,k.月,H0,j2.配置),t=k.所选日期,[e,i]=d0.时间.split(":"),a=D1(t.getFullYear(),t.getMonth()+1,t.getDate(),Number(e),Number(i),0),F=eu(a,e0,R0,Z0,fu,j2.配置),{最终:r,历法结果:g,四柱:E,北斗:h,日级风水禁忌:D,真太阳时结果:l,十二时辰:c,时辰配置错误:x}=F,y=Iu+x.length+j2.错误.length;e0=F.时间依据;const f=d1(r.最终时间),_=j1(H0,g.农历),p=g.节气?`${g.节气.名称} · ${M0(g.节气)}`:"当日无节气",z=g.节气?.名称??"无",G=l?`${J0(l.真太阳时,!0)}（修正 ${mu(l.总修正分钟)}）`:"未取得定位，暂不计算",H=`${r.日柱计算时间.年}年${r.日柱计算时间.月}月${r.日柱计算时间.日}日`,O=d0.模式==="实时"?"实时更新":"手动查询",S=c.项目.flatMap(L=>L.时段),J=hu(S,F0),i0=v2(t),X=Eu(g.每日宜忌);F0&&J?.键!==F0&&(F0=null),$.innerHTML=`
      ...
      <section class="calendar-layout" aria-label="日期核心详情与公历月历">
        <aside class="detail-card" aria-label="所选日期核心详情" aria-live="polite">
          ...
          <section class="almanac-core-row" aria-label="日吉凶值日与风水禁忌">
            ${S2("日吉凶",`${g.日吉凶.天神} · ${g.日吉凶.类型} · ${g.日吉凶.吉凶}`,g.日吉凶.吉凶)}
            ${S2("值日",`${g.值星}日`)}
            ${S2("风水禁忌",Dn(D,"无"),D.命中.length>0?"凶":"normal")}
          </section>
        ...
        <div class="calendar-right">
          ...
          <div class="week-row" role="row">
            ${_n.map((L,c0)=>`<span role="columnheader" title="${c2[c0]}">${L}</span>`).join("")}
          </div>

          <div class="days-grid" data-month-calendar role="grid" aria-label="${k.年}年${k.月+1}月">
            ${u.map(L=>{if(L===null)return'<span class="empty-day" aria-hidden="true"></span>';const c0=new Date(k.年,k.月,L),B0=n[L-1],u2=Y0(c0,E0),q2=Y0(c0,t),A2=[...B0.传统节日,...B0.神圣纪念,...B0.斗降],Bn=A2.length>0?`，${A2.join("、")}`:"",ln=T(`${jn(c0)}，${c2[c0.getDay()]}，农历${B0.农历.显示}${Bn}${u2?"，今天":""}`);return`
                  <button
                    type="button"
                    class="day-button${u2?" is-today":""}${q2?" is-selected":""}"
                    data-day="${L}"
                    role="gridcell"
                    aria-label="${ln}"
                    ${u2?'aria-current="date"':""}
                    ${q2?'aria-selected="true"':'aria-selected="false"'}
                  >
                    <span class="solar-day">${L}</span>
                    <span class="lunar-day">${B0.农历摘要}</span>
                    <span class="day-events" title="${T(A2.join("、"))}">
                      ${B0.显示事件.map(dn=>`<span class="day-event">${T(dn)}</span>`).join("")}
        ...
        <section class="calculation-card" aria-label="时间与计算依据">
          <div class="time-controls">
            ...
            <p class="location-status is-${g0}" aria-live="polite">${z0}</p>
          </div>
          ...
          <p class="config-status${y>0?" has-error":""}">
            规则配置：已读取 ${Z0.length+1} 个文件 · ${ju} 条规则${y>0?` · ${y} 条待修正`:""}
          </p>
        </section>
      </section>
  ...
  `}$.addEventListener("input",u=>{const n=u.target.closest("[data-calendar-date]");if(n){X0=n.value,V0=!0;return}});$.addEventListener("change",u=>{const n=u.target;if(n.matches("[data-calendar-date]"))X0=n.value,n2||U2(n.value,"原生选择");else if(n.matches("[data-bazi-date]"))b0=n.value,T2(),q0();else if(n.matches("[data-bazi-time]"))T0=n.value,T2(),q0();else if(n.matches("[data-bazi-basis]"))U0=n.value==="真太阳时"?"真太阳时":"北京时间",x0="",W();else if(n.matches("[data-bazi-longitude]"))G0=n.value,x0="",q0();else return});$.addEventListener("input",u=>{const n=u.target;if(n.matches("[data-bazi-date]"))b0=n.value;else if(n.matches("[data-bazi-time]"))T0=n.value;else if(n.matches("[data-bazi-longitude]"))G0=n.value;else return;T2(),q0()});$.addEventListener("focusout",u=>{const n=u.target;if(n.matches("[data-calendar-date]")){const t=n2;V0=!1,t?U2(X0??n.value,"键盘"):k0()}else n.matches("[data-bazi-longitude]")&&q0()});$.addEventListener("focusin",u=>{const n=u.target;n.matches("[data-calendar-date]")&&(V0=!0,X0=n.value)});$.addEventListener("pointerdown",u=>{const n=u.target;if(n.matches("[data-calendar-date]")){n2=!1;return}u.button!==0||!n.closest("[data-month-calendar]")||(t0={指针:u.pointerId,起点X:u.clientX,起点Y:u.clientY,已判定为纵向:!1})});$.addEventListener("pointermove",u=>{if(!t0||u.pointerId!==t0.指针||t0.已判定为纵向)return;const n=Math.abs(u.clientX-t0.起点X),t=Math.abs(u.clientY-t0.起点Y);t>=12&&t>n&&(t0.已判定为纵向=!0)});function Pu(u){if(!t0||u.pointerId!==t0.指针)return;const n=t0;if(t0=null,n.已判定为纵向)return;const t=u.clientX-n.起点X,e=u.clientY-n.起点Y;Math.abs(t)<48||Math.abs(t)<Math.abs(e)*1.35||(gn=performance.now()+400,M2(t<0?1:-1))}$.addEventListener("pointerup",Pu);$.addEventListener("pointercancel",u=>{t0?.指针===u.pointerId&&(t0=null)});$.addEventListener("keydown",u=>{const n=u.target;if(n.matches("[data-calendar-date]")){if(u.key==="Enter"){u.preventDefault(),U2(X0??n.value,"键盘");return}if(u.key==="Escape"){u.preventDefault(),k0(),W();return}(/^\d$/u.test(u.key)||["Backspace","Delete","ArrowUp","ArrowDown"].includes(u.key))&&(n2=!0)}});$.addEventListener("click",async u=>{const n=u.target,t=n.closest("[data-deity-dialog]");if(t&&n===t){o1(t);return}const e=n.closest("button");if(!e)return;if(e.dataset.action==="close-deity"){const g=e.closest("[data-deity-dialog]");g&&o1(g);return}const i=e.dataset.sacredCommemoration;if(i!==void 0){const g=En[Number(i)];g&&Yu(g,e);return}if(rn(e.dataset.themePreference)){r2.设置偏好(e.dataset.themePreference),Zu();return}const a=e.dataset.timeBasis;if(a==="北京时间"||a==="真太阳时"){if(a===e0)return;a==="北京时间"?(e0="北京时间",z0=R0===null?"当前使用北京时间":"定位成功，当前使用北京时间",W()):R0!==null?(e0="真太阳时",g0="成功",z0="定位成功，当前使用真太阳时",W()):await F1();return}if(e.dataset.action==="bazi-locate"){await Uu();return}const F=e.dataset.hourKey;if(F){F0=Cu(F,e.classList.contains("is-current")),W();return}if(e.dataset.action==="current-hour"){const g=O0();E0=K0(g),d0=Q0(g),F0=Du(),W();return}const r=e.dataset.day;if(r){if(performance.now()<gn)return;D2(new Date(k.年,k.月,Number(r)));return}switch(e.dataset.action){case"previous-day":a1(-1);break;case"previous-month":M2(-1);break;case"today":b2();break;case"next-day":a1(1);break;case"next-month":M2(1);break;case"back-to-top":window.scrollTo({top:0,behavior:"smooth"});break;case"locate":await F1();break}});$.addEventListener("close",u=>{!(u.target instanceof HTMLDialogElement)||!u.target.matches("[data-deity-dialog]")||(document.body.classList.remove("deity-dialog-open"),Y2?.focus(),Y2=null)},!0);W();const P2=au(u=>{const n=O0(new Date(u)),t=cu(k.所选日期,E0,d0,n);E0=t.今天,Y0(k.所选日期,t.所选日期)||(k=o2(k,t.所选日期)),d0=t.时间查询,t.需要渲染&&!V0&&!$.querySelector("[data-deity-dialog][open]")&&W()});P2.启动();window.addEventListener("pagehide",()=>P2.停止());window.addEventListener("pageshow",()=>P2.启动());
